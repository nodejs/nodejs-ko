---
category: articles
title: Node v10.1.0(현재 버전)
author: James M Snell
ref: Node v10.1.0 (Current)
refurl: https://nodejs.org/en/blog/release/v10.1.0
...
* **console**:
  - console.table()의 색 표현이 가능해졌습니다. (TSUYUSATO Kitsune) [#20510](https://github.com/nodejs/node/pull/20510)
* **fs**:
  - fs/promises를 fs.promises로 이동했습니다. (cjihrig) [#20504](https://github.com/nodejs/node/pull/20504)
* **http**:
  - request에 aborted 속성을 추가했습니다. (Robert Nagy) [#20094](https://github.com/nodejs/node/pull/20094)
* **n-api**:
  - 특별한 심볼로 모듈을 초기화합니다. (Gabriel Schulhof) [#20161](https://github.com/nodejs/node/pull/20161)
* **src**:
  - 주요 V8 플랫폼을 노출하는 공개 API를 추가했습니다. (Allen Yonghuang Wang) [#20447](https://github.com/nodejs/node/pull/20447)
