...
author: Richard Lau
ref: Node v10.23.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.23.0
...
* **n-api**:
  * N-API 버전 7을 생성했습니다. (Gabriel Schulhof) [#35199](https://github.com/nodejs/node/pull/35199)
  * napi_build_version 변수를 노출했습니다. (NickNaso) [#27835](https://github.com/nodejs/node/pull/27835)
* **tools**:
  * macOS 10.15+에서 디버그 권한을 추가했습니다. (Gabriele Greco) [#34378](https://github.com/nodejs/node/pull/34378)
