---
category: articles
title: Node v16.7.0(현재 버전)
author: Danielle Adams
ref: Node v16.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.7.0
...
* **fs**:
  * 실험: 재귀적인 cp 메서드를 추가했습니다.(Benjamin Coe) [#39372](https://github.com/nodejs/node/pull/39372)
