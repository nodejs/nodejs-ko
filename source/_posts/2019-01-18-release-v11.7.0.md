---
category: articles
title: Node v11.7.0 (현재 버전)
author: Myles Borins
ref: Node v11.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.7.0
...
* **compression / zlib**:
  * brotli 지원이 추가되었습니다. (Anna Henningsen and Zach Vacura) [#24938](https://github.com/nodejs/node/pull/24938)
* **console**:
  * `inspectOptions` 옵션이 추가되었습니다. (Ruben Bridgewater) [#24978](https://github.com/nodejs/node/pull/24978)
* **crypto**:
  * 항상 공개 키로 비공개 키를 수락합니다. (Tobias Nießen) [#25217](https://github.com/nodejs/node/pull/25217)
* **deps**:
  * npm v6.5.0 으로 업그레이드했습니다. (Jordan Harband) [#25234](https://github.com/nodejs/node/pull/25234)
* **fs**:
  * process.binding('fs')을 사용하는 대신 internalBinding('fs')을 내부적으로 사용합니다. (Masashi Hirano) [#22478](https://github.com/nodejs/node/pull/22478)
* **http(s)**:
  * http\\s.globalAgent 오버라이딩을 지원합니다. (Roy Sommer) [#25170](https://github.com/nodejs/node/pull/25170)
* **util**:
  * ArrayBuffers 내용을 정밀히 조사합니다. (Ruben Bridgewater) [#25006](https://github.com/nodejs/node/pull/25006)
* **worker**:
  * 기본적으로 워커를 노출하고, `--experimental-worker` 플래그를 삭제 했습니다. (Anna Henningsen) [#25361](https://github.com/nodejs/node/pull/25361)
