...
* **crypto**:
  * 항상 공개키 대신 비공개키를 수락합니다. (Tobias Nießen) [#25217](https://github.com/nodejs/node/pull/25217)
* **deps**:
  * npm v6.5.0으로 업그레이드했습니다. (Jordan Harband) [#25234](https://github.com/nodejs/node/pull/25234)
* **fs**:
...
* **worker**:
  * 기본적으로 워커를 노출하고, `--experimental-worker` 플래그를 삭제했습니다. (Anna Henningsen) [#25361](https://github.com/nodejs/node/pull/25361)
