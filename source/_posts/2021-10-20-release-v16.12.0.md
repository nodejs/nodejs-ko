...
* \[[`d1d9f2de30`](https://github.com/nodejs/node/commit/d1d9f2de30)] - **doc**: http에서 abort와 관련된 부분을 문서에서만 먼저 폐기 예정으로 표시합니다. (dr-js) [#36670](https://github.com/nodejs/node/pull/36670)
