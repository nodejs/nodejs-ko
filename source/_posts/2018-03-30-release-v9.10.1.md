---
category: articles
title: Node v9.10.1(유지보수 버전)
author: Myles Borins
ref: Node v9.10.1 (Maintenance)
...
Node.js 버전 10.X와 그 이후 버전은 4.9.X 또는 그 이후 버전의 GCC 컴파일러로 만들어질 예정이며 Node.js 버전 9.X의 최소 컴파일러 요구사항을 만족한 이후에 Node.js 9.X 버전이 4.9.X(4.9.4)버전으로 만들어질 수 있습니다.
