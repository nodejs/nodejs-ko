...
* **fs**:
  * writeFile이 AbortSignal을 지원합니다. (Benjamin Gruenbaum) [#35993](https://github.com/nodejs/node/pull/35993)
  * readFile이 AbortSignal을 지원합니다. (Benjamin Gruenbaum) [#35911](https://github.com/nodejs/node/pull/35911)
* **stream**:
