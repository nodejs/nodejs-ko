---
category: articles
title: Node v4.1.0 (안정 버전)
author: Node
ref: Node v4.1.0 (Stable)
refurl: https://nodejs.org/en/blog/release/v4.1.0/
translator:
...
* **npm**: 2.14.3 버전으로 업그레이드했습니다, 자세한 사항은 <https://github.com/npm/npm/releases/tag/v2.14.3>을 참조하세요. (Kat Marchán) [#2822](https://github.com/nodejs/node/pull/2822).
