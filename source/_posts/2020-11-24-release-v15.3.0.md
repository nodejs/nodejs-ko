---
category: articles
title: Node v15.3.0(현재 버전)
author: Shelley Vohr
ref: Node v15.3.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.3.0
...
* [[`6349b1d673`](https://github.com/nodejs/node/commit/6349b1d673)] - **(SEMVER-MINOR)** **dns**: promise 리졸버에 cancel() 메서드를 추가했습니다. (Szymon Marczak) [#33099](https://github.com/nodejs/node/pull/33099)
* [[`9ce9b016e6`](https://github.com/nodejs/node/commit/9ce9b016e6)] - **(SEMVER-MINOR)** **events**: EventTarget에 최대 리스너 경고를 추가했습니다. (James M Snell) [#36001](https://github.com/nodejs/node/pull/36001)
* [[`8390f8a86b`](https://github.com/nodejs/node/commit/8390f8a86b)] - **(SEMVER-MINOR)** **http**: http.request에서 AbortSignal을 지원합니다. (Benjamin Gruenbaum) [#36048](https://github.com/nodejs/node/pull/36048)
* [[`9c6be3cc90`](https://github.com/nodejs/node/commit/9c6be3cc90)] - **(SEMVER-MINOR)** **http2**: 세션의 로컬 윈도우 크기를 설정할 수 있습니다. (Yongsheng Zhang) [#35978](https://github.com/nodejs/node/pull/35978)
* [[`15ff155c12`](https://github.com/nodejs/node/commit/15ff155c12)] - **(SEMVER-MINOR)** **lib**: add throws option to fs.f/l/statSync에 예외를 던질지 말지에 대한 옵션을 설정할 수 있습니다. (Andrew Casey) [#33716](https://github.com/nodejs/node/pull/33716)
* [[`85c85d368a`](https://github.com/nodejs/node/commit/85c85d368a)] - **(SEMVER-MINOR)** **path**: `path/posix`와 `path/win32` 별칭 모듈을 추가했습니다. (ExE Boss) [#34962](https://github.com/nodejs/node/pull/34962)
* [[`d1baae3640`](https://github.com/nodejs/node/commit/d1baae3640)] - **(SEMVER-MINOR)** **readline**: 현재 프롬프트를 가져오는 getPrompt를 추가했습니다. (Mattias Runge-Broberg) [#33675](https://github.com/nodejs/node/pull/33675)
* [[`5729478509`](https://github.com/nodejs/node/commit/5729478509)] - **(SEMVER-MINOR)** **src**: 진단 보고서에 루프 유휴 시간을 추가했습니다. (Gireesh Punathil) [#35940](https://github.com/nodejs/node/pull/35940)
* [[`baa87c1a7d`](https://github.com/nodejs/node/commit/baa87c1a7d)] - **(SEMVER-MINOR)** **util**: `util/types` 별칭 모듈을 추가했습니다. (ExE Boss) [#34055](https://github.com/nodejs/node/pull/34055)
