...
* [[`15ff155c12`](https://github.com/nodejs/node/commit/15ff155c12)] - **(SEMVER-MINOR)** **lib**: fs.f/l/statSync에 예외를 던질지 말지에 대한 옵션을 설정할 수 있습니다. (Andrew Casey) [#33716](https://github.com/nodejs/node/pull/33716)
