...
author: Myles Borins
ref: Node v6.10.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.10.0
translator:
...
*  **crypto**: 알려진 CA에 인증서를 추가할 수 있습니다.(Sam Roberts) [#9139](https://github.com/nodejs/node/pull/9139)
*  **deps**: INTL ICU를 58 버전으로 업그레이드했습니다.(Steven R. Loomis) [#9234](https://github.com/nodejs/node/pull/9234)
*  **process**: `process.memoryUsage.external`을 추가했습니다.(Fedor Indutny) [#9587](https://github.com/nodejs/node/pull/9587)
*  **src**: `process.emitWarning()`의 래퍼를 추가했습니다.(Sam Roberts) [#9139](https://github.com/nodejs/node/pull/9139)


주요 SEMVER-PATCH 변경사항은 다음과 같습니다.

*  **fs**: realpathSync에 심볼릭 링크가 아닌 경로를 캐시합니다.(Jeremy Yallop) [#10253](https://github.com/nodejs/node/pull/10253)
*  **repl**: 스코프에 속한 패키지도 자동완성할 수 있게 됐습니다.(Evan Lucas) [#10296](https://github.com/nodejs/node/pull/10296)
