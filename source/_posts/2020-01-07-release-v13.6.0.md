---
category: articles
title: Node v13.6.0(현재 버전)
author: Ruben Bridgewater
ref: Node v13.6.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.6.0
translator: taggon
---
...
* **assert**:
  * `assert.match()`와 `assert.doesNotMatch()`를 구현했습니다. (Ruben Bridgewater) [#30929](https://github.com/nodejs/node/pull/30929)
* **events**:
  * 이벤트를 비동기로 훑을 수 있는 `EventEmitter.on` 함수를 추가했습니다. (Matteo Collina) [#27994](https://github.com/nodejs/node/pull/27994)
  * 에러 이벤트를 모니터링 할 수 있게 했습니다. (Gerhard Stoebich) [#30932](https://github.com/nodejs/node/pull/30932)
* **fs**:
  * 스트림의 `fs`를 오버라이드 할 수 있게 했습니다. (Robert Nagy) [#29083](https://github.com/nodejs/node/pull/29083)
* **perf_hooks**:
  * `perf_hooks`가 실험 상태에서 벗어나 안정(stable) 상태로 바뀌었습니다. (legendecas) [#31101](https://github.com/nodejs/node/pull/31101)
* **repl**:
  * ZSH와 유사한 역점진탐색(reverse-i-search)을 구현했습니다. (Ruben Bridgewater) [#31006](https://github.com/nodejs/node/pull/31006)
* **tls**:
  * PSK (pre-shared key)를 지원합니다. (Denys Otrishko) [#23188](https://github.com/nodejs/node/pull/23188)
