...
이번에 릴리스 된 새로운 메이저 버전은 ES6 언어의 기능을 98% 지원하며 신뢰성과 성능이 개선된 V8 5.4를 포함하고 있으며, [WHATWG URL 표준](https://url.spec.whatwg.org/)에 바탕을 둔 실험적인 URL 파서도 포함하고 있습니다.
...
* Buffer
  ...
  * new 키워드 없이 Buffer를 호출하는 방법은 폐지 예정(deprecated)이며 이 방법을 사용하면 프로세스 경고가 발생합니다. [#8169](https://github.com/nodejs/node/pull/8169)
