...
* Buffer
  ...
  * `Buffer.prototype.lastIndexOf()` 메서드가 추가되었습니다.
    [#4846](https://github.com/nodejs/node/pull/4846)
* Cluster
...
* Events
  ...
  * `EventEmitter.prototype.prependListener()`와
    `EventEmitter.prototype.prependOnceListener()` 메서드를 추가했습니다.
    [#6032](https://github.com/nodejs/node/pull/6032)
* File System
  * `fs.realpath()`와 `fs.realpathSync()` 메서드는 더 효율적인 libuv에 기반을 둔
...
* Util
  * 오류 객체 포맷이 변경되었습니다.
    [#4582](https://github.com/nodejs/node/pull/4582)
  * `util._extend()` 메서드는 폐기되었습니다.
    [#4903](https://github.com/nodejs/node/pull/4903)
  * `util.log()` 메서드는 폐기되었습니다.
    [#6161](https://github.com/nodejs/node/pull/6161)
* Windows
