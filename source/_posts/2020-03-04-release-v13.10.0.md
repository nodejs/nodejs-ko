...
* **stream**
  * `pipeline()`에 제너레이터 함수를 전달할 수 있습니다. (Robert Nagy) [#31223](https://github.com/nodejs/node/pull/31223)
* **tls**
  * `SSL_export_keying_material`에 접근할 수 있게 했습니다. (simon) [#31814](https://github.com/nodejs/node/pull/31814)
* **vm**
