---
category: articles
title: Node v13.10.0(현재 버전)
author: Shelley Vohr
ref: Node v13.10.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.10.0
translator: taggon
---
...
* **async_hooks**
  * async-context API를 도입했습니다. (vdeturckheim) [#26540](https://github.com/nodejs/node/pull/26540)
* **stream**
  * `pipeline()`에 생성자 함수를 전달할 수 있습니다. (Robert Nagy) [#31223](https://github.com/nodejs/node/pull/31223)
* **tls**
  * `SSL\_export\_keying\_material`에 접근할 수 있게 했습니다. (simon) [#31814](https://github.com/nodejs/node/pull/31814)
* **vm**
  * 컨텍스트별 메모리 사용량을 측정하는 `vm.measureMemory()`를 추가했습니다. (Joyee Cheung) [#31824](https://github.com/nodejs/node/pull/31824)
