---
category: articles
title: Node v10.5.0(현재 버전)
author: Michaël Zasso
ref: Node v10.5.0 (Current)
refurl: https://nodejs.org/en/blog/release/v10.5.0
...
* **crypto**:
  * `crypto.scrypt()` 지원을 추가했습니다. [#20816](https://github.com/nodejs/node/pull/20816)
* **fs**:
  * `fs.stat`과 `fs.watchFile`에 BigInt 지원을 추가했습니다. [#20220](https://github.com/nodejs/node/pull/20220)
  * `mode`를 인자로 받는 API가 더는 `0o777`보다 클 때 오류를 던지지 않습니다.
    [#20636](https://github.com/nodejs/node/pull/20636) [#20975](https://github.com/nodejs/node/pull/20975) (수정: [#20498](https://github.com/nodejs/node/issues/20498))
  * 닫힌 이벤트 감시자에서 발생하는 크래시를 수정했습니다. [#20985](https://github.com/nodejs/node/pull/20985) (수정: [#20297](https://github.com/nodejs/node/issues/20297))
* **워커 스레드**:
  * `worker_threads` 모듈의 `--experimental-worker` 플래그로 멀티스레딩 지원을
    추가했습니다. 이 기능은 *실험적*이며 언제든 호환성을 깨뜨리는 변경이 발생할 수 있습니다.
    [#20876](https://github.com/nodejs/node/pull/20876)
