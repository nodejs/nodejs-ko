---
category: articles
title: Node v6.4.0(현재 버전)
author: Colin Ihrig
ref: Node v6.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v6.4.0/
...
-->
* **build**: 윈도우 플랫폼에서 zlib 심볼과 추가적인 OpenSSL 심볼을 사용할 수 있습니다. (Alex Hultman) [#7983](https://github.com/nodejs/node/pull/7983), [#7576](https://github.com/nodejs/node/pull/7576)
* **child_process**, **cluster**: 포크된 자식 프로세스와 클러스터 워커에서 표준 입출력 설정을 지원합니다. (Colin Ihrig) [#7811](https://github.com/nodejs/node/pull/7811), [#7838](https://github.com/nodejs/node/pull/7838)
* **child_process**: 생성된 프로세스의 `argv[0]`에 임의의 값을 설정할 수 있습니다. (Pat Pannuto) [#7696](https://github.com/nodejs/node/pull/7696)
* **fs**: `fs.ReadStream`를 사용할 때 현재까지 읽어들인 바이트 수를 알 수 있습니다. (Linus Unnebäck) [#7942](https://github.com/nodejs/node/pull/7942)
* **repl**: REPL에서 에디터 모드를 지원합니다. (Prince J Wesley) [#7275](https://github.com/nodejs/node/pull/7275)
* **util**: `util.inspect.defaultOptions`를 사용하여 `inspect()`를 전역으로 설정할 수 있습니다. (Roman Reiss) [#8013](https://github.com/nodejs/node/pull/8013)
