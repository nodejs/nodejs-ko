...
* **meta**
  - 기여자들에 Leko를 추가했습니다. (Leko) [#18117](https://github.com/nodejs/node/pull/18117)
  - 기여자로 vdeturckheim을 추가했습니다. (vdeturckheim) [#18432](https://github.com/nodejs/node/pull/18432)
* **n-api**
  - process.versions에서 n-api 버전을 보여줍니다. (Michael Dawson) [#18067](https://github.com/nodejs/node/pull/18067)
* **perf_hooks**
  - performance.clear()를 추가했습니다. (James M Snell) [#18046](https://github.com/nodejs/node/pull/18046)
* **stream**
  - 종료하는 동안 writeAfterEnd()를 피합니다. (陈刚) [#18170](https://github.com/nodejs/node/pull/18170)
