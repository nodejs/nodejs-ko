...
* **Dependencies**
  - libuv이 1.12.0 버전으로 업데이트했습니다. [[`968596ec77`](https://github.com/nodejs/node/commit/968596ec77)] [#13487](https://github.com/nodejs/node/pull/13487)
  - npm이 5.0.3 버전으로 업데이트했습니다. [[`ffa7debd7a`](https://github.com/nodejs/node/commit/ffa7debd7a)] [#13487](https://github.com/nodejs/node/pull/13487)
* **File system**
  ...
  - 이제 fs.Stats의 times는 숫자로도 지정할 수 있습니다. [[`c756efb25a`](https://github.com/nodejs/node/commit/c756efb25a)] [#13173](https://github.com/nodejs/node/pull/13173)
* **Inspector**
...
* **Zlib**
  - zlib.Deflate와 기타 Zlib 클래스들을 적절하게 하위 클래스로 만들지 못하게 하는 Zlib 모듈의 회귀를 수정했습니다. [[`6aeb555cc4`](https://github.com/nodejs/node/commit/6aeb555cc4)] [#13374](https://github.com/nodejs/node/pull/13374)
