---
category: articles
title: Node v8.1.0 (현재 버전)
author: James M Snell, Rod Vagg
ref: Node v8.1.0 (Current)
refurl: https://nodejs.org/en/blog/release/v8.1.0
...
* **Async Hooks**
  - 'Promise'를 사용하여 새로운 'Promise'를 생성하게 되면, 생성 시에 사용된 부모 'Promise'는 트리거로 인식됩니다. [[`135f4e6643`](https://github.com/nodejs/node/commit/135f4e6643)] [#13367](https://github.com/nodejs/node/pull/13367)
* **Dependencies**
  - libuv이 1.12.0 버전으로 업데이트되었습니다. [[`968596ec77`](https://github.com/nodejs/node/commit/968596ec77)] [#13487](https://github.com/nodejs/node/pull/13487)
  - npm이 5.0.3 버전으로 업데이트되었습니다. [[`ffa7debd7a`](https://github.com/nodejs/node/commit/ffa7debd7a)] [#13487](https://github.com/nodejs/node/pull/13487)
* **File system**
  - 이제 fs.exists() 함수가 util.promisify() 와 함께 올바르게 작동합니다. [[`6e0eccd7a1`](https://github.com/nodejs/node/commit/6e0eccd7a1)] [#13316](https://github.com/nodejs/node/pull/13316)
  - 이제 fs.Stats의 times 는 숫자로도 지정할 수 있습니다. [[`c756efb25a`](https://github.com/nodejs/node/commit/c756efb25a)] [#13173](https://github.com/nodejs/node/pull/13173)
* **Inspector**
  - 이제 --inspect=0을 사용하여, 임의의 포트에 할당할 수 있습니다. [[`cc6ec2fb27`](https://github.com/nodejs/node/commit/cc6ec2fb27)] [#5025](https://github.com/nodejs/node/pull/5025)
* **Zlib**
  - zlib.Deflate와 기타 Zlib 클래스들을 적절하게 하위 클래스로 만들지 못하게 하는 Zlib 모듈의 회귀가 수정되었습니다. [[`6aeb555cc4`](https://github.com/nodejs/node/commit/6aeb555cc4)] [#13374](https://github.com/nodejs/node/pull/13374)
