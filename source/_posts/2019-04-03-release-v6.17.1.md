...
ref: Node v6.17.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.17.1
translator: Fleta
---
...
Node 6은 2019년 4월 30일에 수명이 종료됩니다. [릴리스 일정](https://nodejs.org/en/about/releases/)을 참고하세요.

### 주요 변경사항

* **http**:
  - `Execute()`의 오류 검사를 수정했습니다. (Brian White) [#25939](https://github.com/nodejs/node/pull/25939)
