---
category: articles
title: Node v11.14.0(현재 버전)
author: Bethany Nicolle Griggs
ref: Node v11.14.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.14.0
...
* **child_process**: 문서에서 ChildProcess.\_channel이 폐지 예정(deprecated) 상태가 되었습니다. (cjihrig) [#26982](https://github.com/nodejs/node/pull/26982)
* **deps**: nghttp2가 1.37.0으로 업데이트되었습니다. (gengjiawen) [#26990](https://github.com/nodejs/node/pull/26990)
* **dns**:
  * dns.promises를 enumerable하게 변경했습니다. (cjihrig) [#26592](https://github.com/nodejs/node/pull/26592)
  * dns.promises의 실험상태 경고를 제거했습니다. (cjihrig) [#26592](https://github.com/nodejs/node/pull/26592)
* **fs**: fs.promises의 실험상태 경고를 제거했습니다. (Anna Henningsen) [#26581](https://github.com/nodejs/node/pull/26581)
* **stream**: Symbol.asyncIterator를 안정 상태로 변경했습니다. (Matteo Collina) [#26989](https://github.com/nodejs/node/pull/26989)
* **worker**: process.env의 복사본을 사용합니다. (Anna Henningsen) [#26544](https://github.com/nodejs/node/pull/26544)
