...
* `assert.fail()`에 하나 이상의 인자를 전달하면 실행 시 폐기 경고가 발생합니다. [[`70dcacd710`](https://github.com/nodejs/node/commit/70dcacd710)]
* 폐기되었던 async_hooks API는 수명을 다해 제거되었습니다. [[`1cc6b993b9`](https://github.com/nodejs/node/commit/1cc6b993b9)]
* 여러 Node.js의 내부 의존성에 접근하기 위해 사용된 `require()`는 런타임 에러가 발생합니다. [[`0e10717e43`](https://github.com/nodejs/node/commit/0e10717e43)]
* `crypto.createCipher()`와 `crypto.createDecipher()`메소드는 문서에서 폐기되었습니다.[[`81f88e30dd`](https://github.com/nodejs/node/commit/81f88e30dd)]
...
* `process.env`를 위한 문자열이 아닌 값의 사용은 문서에서 폐기되었습니다. [[`5826fe4e79`](https://github.com/nodejs/node/commit/5826fe4e79)]
...
* `crypto.fips` 프로퍼티는 문서에서 폐기되었습니다. [[`6e7992e8b8`](https://github.com/nodejs/node/commit/6e7992e8b8)]
