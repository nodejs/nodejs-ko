...
author: Myles Borins
ref: Node v6.10.3 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.10.3
translator: taggon
---
...
* **module**
  - 윈도우즈에서 [모듈 로딩 전역 폴백](https://nodejs.org/dist/latest-v4.x/docs/api/modules.html#modules_loading_from_the_global_folders)이 올바르게 Node 실행 파일이 있는 디렉터리를 가리키도록 수정했습니다. (Richard Lau) [#9283](https://github.com/nodejs/node/pull/9283)
* **src**
