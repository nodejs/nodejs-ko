---
category: articles
title: Node v12.9.1(현재 버전)
author: Michaël Zasso
ref: Node v12.9.1 (Current)
refurl: https://nodejs.org/en/blog/release/v12.9.1
...
이번 릴리스는 **http** 모듈의 두가지 회귀 문제를 수정합니다.

* HTTP 클라이언트에서 이벤트 리스너의 누수 문제를 수정했습니다. 이로 인해 npm/yarn으로 설치할 때 많은
  경고가 나왔습니다. (Robert Nagy) [#29245](https://github.com/nodejs/node/pull/29245).
* keepalive 요청에서 바디 전체가 파싱되지 않은 경우 `'end'` 이벤트가 발생하는 회귀 문제를
  수정했습니다. (Matteo Collina) [#29263](https://github.com/nodejs/node/pull/29263).
