...
ref: Node v12.18.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v12.18.2
translator: taggon
---
...
* **deps**: V8: fb26d0bb1835를 백포트했습니다. (Matheus Marchini) [#33573](https://github.com/nodejs/node/pull/33573)
  * `PrototypeUsers::Add`에서 발생하는 메모리 누수를 수정합니다.
* **src**: `AsyncWrap` 리소스를 저장할 때 심볼을 사용합니다. (Anna Henningsen) [#31745](https://github.com/nodejs/node/pull/31745)
  * [#33468](https://github.com/nodejs/node/issues/33468)에서 보고된 메모리 누수 문제를 수정합니다.
