---
category: articles
title: Node v11.4.0(현재 버전)
author: Ruben Bridgewater
ref: Node v11.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.4.0
translator: Fleta
---
...
* **console, util**:
  ...
  * inspect `depth`의 기본값이 다시 2로 돌아갑니다. https://github.com/nodejs/node/pull/24326
* **dgram, net**:
  * `net`과 `dgram`에 ipv6Only 옵션이 추가됩니다. https://github.com/nodejs/node/pull/23798
* **http**:
  * 이제 런타임 플래그를 통해 http 파서를 선택할 수 있습니다. https://github.com/nodejs/node/pull/24739
* **readline**:
  * 이제 `readline` 모듈이 비동기 이터레이터를 지원합니다. https://github.com/nodejs/node/pull/23916
* **repl**
  * 멀티라인 히스토리 기능이 삭제되었습니다. https://github.com/nodejs/node/pull/24804
* **tls**
  * 최저/최고 프로토콜 버전 옵션이 추가되었습니다. https://github.com/nodejs/node/pull/24005
  * 이제 X.509 공개키 정보에 RSA 비트 사이즈와 타원 곡선이 추가됩니다. https://github.com/nodejs/node/pull/24358
* **url**:
...
* **Windows**:
  ...
  * install-tools 스크립트가 이제 배포판에 포함되어 있습니다. https://github.com/nodejs/node/pull/24233
* **새 협력자 추가**:
  * [antsmartian](https://github.com/antsmartian) - Anto Aravinth. https://github.com/nodejs/node/pull/24655
