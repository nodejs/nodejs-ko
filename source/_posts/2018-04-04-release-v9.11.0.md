---
category: articles
title: Node v9.11.0(현재 버전)
author: Myles Borins
ref: Node v9.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.11.0
...
* **deps**:
  - ICU가 61.1로 업데이트되었습니다. (Steven R. Loomis) [#19621](https://github.com/nodejs/node/pull/19621)
    CLDR 33을 추가했습니다(많은 새로운 언어와 데이터 강화).
* **fs**:
  - `ReadStream`과 `WriteStream`을 위해 'ready' 이벤트를 발생시킵니다. (Sameer Srivastava) [#19408](https://github.com/nodejs/node/pull/19408)
* **n-api**:
  - 지원하는 n-api 버전을 올렸습니다. (Michael Dawson) [#19497](https://github.com/nodejs/node/pull/19497)
* **net**:
  - `Socket`을 위해 'ready' 이벤트를 발생시킵니다. (Sameer Srivastava) [#19408](https://github.com/nodejs/node/pull/19408)
* **새로운 협업자를 추가했습니다.**
  - [mafintosh](https://github.com/mafintosh) Mathias Buus
