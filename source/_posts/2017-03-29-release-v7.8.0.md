---
category: articles
title: Node v7.8.0(현재 버전)
author: Myles Borins
ref: Node v7.8.0 (Current)
refurl: https://nodejs.org/en/blog/release/v7.8.0
translator: taggon
---
...
* **buffer**
  - 범위를 벗어난(out-of-range) 인덱스가 세그멘테이션 오류를 일으키지 않도록 했습니다. (Timothy Gu) [#11927](https://github.com/nodejs/node/pull/11927)
* **crypto**
  - 인증서를 폐기하면 발생하는 메모리 누수를 수정했습니다. (Tom Atkinson) [#12089](https://github.com/nodejs/node/pull/12089)
* **deps**
  * npm을 4.2.0으로 업그레이드했습니다. (Kat Marchán) [#11389](https://github.com/nodejs/node/pull/11389)
  * V8에서 async await 구문을 위해 추가했던 편의 기능을 제거했습니다. (Michaël Zasso) [#12004](https://github.com/nodejs/node/pull/12004)
* **readline**
  - 명령 히스토리에 중복되는 항목을 추가하지 않는 옵션을 추가했습니다. (Danny Nemer) [#2982](https://github.com/nodejs/node/pull/2982)
