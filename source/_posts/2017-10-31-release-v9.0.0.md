...
* **HTTP/1**
  ...
  * 소켓 커넥션이 일어났을때 타임아웃이 설정됩니다. [[`10be20a0e8`](https://github.com/nodejs/node/commit/10be20a0e8)] [#8895](https://github.com/nodejs/node/pull/8895)
  * Error 이벤트를 두번 발생시키는 Request 버그가 수정되었습니다. [[`620ba41694`](https://github.com/nodejs/node/commit/620ba41694)] [#14659](https://github.com/nodejs/node/pull/14659)
...
* **Timers**
  * `setTimeout()`이 받는 timeout값이 부호없는 32비트 정수범위를 초과하는 경우 경고가 발생합니다. [[`ce3586da31`](https://github.com/nodejs/node/commit/ce3586da31)] [#15627](https://github.com/nodejs/node/pull/15627)
