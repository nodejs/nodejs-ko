...
* **fs**
  * `fs.ReadStream`과 `fs.WriteStream` 클래스들은 이제 `destroy()`를 사용합니다. [[`e5c290bed9`](https://github.com/nodejs/node/commit/e5c290bed9)] [#15407](https://github.com/nodejs/node/pull/15407)
...
* **HTTP/1**
  ...
  * HTTP 클라이언트는 `net.Socket`뿐만 아니라 범용 `Duplex` 스트림도 사용할 수 있습니다. [[`3e25e4d00f`](https://github.com/nodejs/node/commit/3e25e4d00f)] [#16267](https://github.com/nodejs/node/pull/16267)
