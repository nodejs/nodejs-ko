---
category: articles
title: Node v15.11.0(현재 버전)
author: Michaël Zasso
ref: Node v15.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.11.0
...
* [[`a3e3156b52`](https://github.com/nodejs/node/commit/a3e3156b52)] - **(SEMVER-MINOR)** **crypto**: FIPS 관련 옵션을 항상 사용할 수 있게 되었습니다. (Vít Ondruch) [#36341](https://github.com/nodejs/node/pull/36341)
* [[`9ba5c0f9ba`](https://github.com/nodejs/node/commit/9ba5c0f9ba)] - **(SEMVER-MINOR)** **errors**: --enable-source-maps의 안정성을 실험적이라고 표시한 부분을 제거했습니다. (Benjamin Coe) [#37362](https://github.com/nodejs/node/pull/37362)
