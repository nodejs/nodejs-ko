...
* **crypto**:
  - 1.1.0과 1.0.2모두 지원합니다. (David Benjamin) [#16130](https://github.com/nodejs/node/pull/16130)
* **fs**:
  - fs.realpathSync.native와 fs.realpath.native이 공개 되었습니다. (Ben Noordhuis) [#15776](https://github.com/nodejs/node/pull/15776)
* **process**:
