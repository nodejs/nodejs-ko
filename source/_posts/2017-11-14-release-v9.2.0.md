---
category: articles
title: Node v9.2.0(현재 버전)
author: Evan Lucas
ref: Node v9.2.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.2.0
...
* **crypto**:
  - OpenSSL 1.1.0과 1.0.2 모두 지원합니다. (David Benjamin) [#16130](https://github.com/nodejs/node/pull/16130)
* **fs**:
  - 이제 fs.realpathSync.native와 fs.realpath.native 함수를 사용 할 수 있습니다. (Ben Noordhuis) [#15776](https://github.com/nodejs/node/pull/15776)
* **process**:
  - 이제 process.ppid 함수를 사용 할 수 있습니다. (cjihrig) [#16839](https://github.com/nodejs/node/pull/16839)
