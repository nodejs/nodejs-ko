...
* **deps**:
    - *npm*: npm을 3.10.10으로 업그레이드 했습니다. (Rebecca Turner) [#9847](https://github.com/nodejs/node/pull/9847)
    - *V8*: 계산된 속성에 화살표 함수의 디스트럭처링을 사용할 때 더 이상 예외를 발생시키지 않습니다. (Michaël Zasso) [#10386](https://github.com/nodejs/node/pull/10386)
* **inspector**: /json/version은 배열에 감싸진 객체가 아닌 객체를 반환합니다. (Ben Noordhuis) [#9762](https://github.com/nodejs/node/pull/9762)
* **module**: 이제 --debug-brk와 --eval을 동시에 사용할 때 예상한 대로 동작합니다. (Kelvin Jin) [#8876](https://github.com/nodejs/node/pull/8876)
