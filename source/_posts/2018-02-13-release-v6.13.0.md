...
author: Myles Borins
ref: Node v6.13.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.13.0/
...
* **console**:
  - console.count()와 console.clear()를 추가했습니다. (James M Snell) [#12678](https://github.com/nodejs/node/pull/12678)
* **crypto**:
  - ECDH 클래스를 노출시킵니다. (Bryan English) [#8188](https://github.com/nodejs/node/pull/8188)
  - cypto.randomFill()과 crypto.randomFillSync()를 추가했습니다. (Evan Lucas) [#10209](https://github.com/nodejs/node/pull/10209)
  - 유효하지 않은 인증 태그 길이를 경고합니다. (Tobias Nießen) [#17566](https://github.com/nodejs/node/pull/17566)
* **deps**:
  - libuv를 1.16.1로 업그레이드했습니다. (cjihrig) [#16835](https://github.com/nodejs/node/pull/16835)
* **dgram**:
  - socket.setMulticastInterface()를 추가했습니다. (Will Young) [#7855](https://github.com/nodejs/node/pull/7855)
* **http**:
  - `Agent`의 keep-alive 행위를 오버라이드 가능하게 하기 위한 agent.keepSocketAlive와 agent.reuseSocket을 추가했습니다. (Fedor Indutny) [#13005](https://github.com/nodejs/node/pull/13005)
* **lib**:
  - net.Socket.end()가 this를 반환하게 했습니다. (Sam Roberts) [#13481](https://github.com/nodejs/node/pull/13481)
* **module**:
  - Node의 모든 내장 모듈 리스트를 제공하는 builtinModules api를 추가했습니다. (Jon Moss) [#16386](https://github.com/nodejs/node/pull/16386)
* **net**:
  - getConnections()가 this를 반환하도록 했습니다. (Sam Roberts) [#13553](https://github.com/nodejs/node/pull/13553)
* **promises**:
  - 처리되지 않은 거절에 대한 문자열 표시를 개선했습니다. (Timothy Gu) [#13784](https://github.com/nodejs/node/pull/13784)
* **repl**:
  - require()의 자동 완성 기능을 개선했습니다. (Alexey Orlenko) [#14409](https://github.com/nodejs/node/pull/14409)
* **src**:
  - openssl-system-ca-path 설정 옵션을 추가했습니다. (Daniel Bevenius) [#16790](https://github.com/nodejs/node/pull/16790)
  - --use-bundled-ca --use-openssl-ca 확인을 추가했습니다. (Daniel Bevenius) [#12087](https://github.com/nodejs/node/pull/12087)
  - process.ppid를 추가했습니다. (cjihrig) [#16839](https://github.com/nodejs/node/pull/16839)
* **tls**:
  - `tls.connect()`에서 `lookup` 옵션을 받습니다. (Fedor Indutny) [#12839](https://github.com/nodejs/node/pull/12839)
* **tools, build**:
  - 새로운 macOS 인스톨러! (JP Wesselink) [#15179](https://github.com/nodejs/node/pull/15179)
* **url**:
  - WHATWG URL api 지원 (James M Snell) [#7448](https://github.com/nodejs/node/pull/7448)
* **util**:
  - %i와 %f 포매팅 지정자를 추가했습니다. (Roman Reiss) [#10308](https://github.com/nodejs/node/pull/10308)
