...
* **console**:
  - console.count()와 console.clear()가 추가되었습니다. (James M Snell) [#12678](https://github.com/nodejs/node/pull/12678)
* **crypto**:
  - ECDH 클래스 공개 (Bryan English) [#8188](https://github.com/nodejs/node/pull/8188)
  - cypto.randomFill()과 crypto.randomFillSync()가 추가되었습니다. (Evan Lucas) [#10209](https://github.com/nodejs/node/pull/10209)
...
* **http**:
  - agent.keepSocketAlive와 `Agent`의 keep-alive 행위를 오버라이드 가능하게 하기 위한 agent.reuseSocket을 추가했습니다. (Fedor Indutny) [#13005](https://github.com/nodejs/node/pull/13005)
* **lib**:
...
* **promises**:
  - 처리하지 않은 거절에 관한 stringification을 더욱 강화 (Timothy Gu) [#13784](https://github.com/nodejs/node/pull/13784)
* **repl**:
  - require() 자동완성 강화 (Alexey Orlenko) [#14409](https://github.com/nodejs/node/pull/14409)
* **src**: 
...
* **tls**:
  - `tls.connect()`를 위한 `lookup` 옵션을 수락했습니다. (Fedor Indutny) [#12839](https://github.com/nodejs/node/pull/12839)
* **tools, build**: 
