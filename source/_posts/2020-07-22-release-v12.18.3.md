...
author: Shelley Vohr
ref: Node v12.18.3 (LTS)
refurl: https://nodejs.org/en/blog/release/v12.18.3
...
* **deps:**
  ...
  * node-inspect를 v2.0.0으로 업데이트했습니다. (Jan Krems) [#33447](https://github.com/nodejs/node/pull/33447)
  * uvwasi: 9e75217를 체리픽했습니다. (Colin Ihrig) [#33521](https://github.com/nodejs/node/pull/33521)
