---
category: articles
title: Node v7.7.0(현재 버전)
author: Italo A. Casas
ref: Node v7.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v7.7.0
translator: taggon
---
...
이 문제에 관한 자세한 내용은 [해당 이슈](https://github.com/nodejs/node/issues/11628)를 확인해주세요.
...
* **child_process**: 자식 프로세스가 시그널로 종료된 경우 spawnSync() 종료 코드가 null이 됩니다. (cjihrig) [#11288](https://github.com/nodejs/node/pull/11288)
* **http**: 전송하는 HTTP 메시지 헤더에 접근하는 함수를 추가했습니다. (Brian White) [#11562](https://github.com/nodejs/node/pull/11562)
* **lib**: 런타임에서 node --debug를 폐지 예정으로 변경했습니다. (Josh Gavant) [#11275](https://github.com/nodejs/node/pull/11275)
* **tls**: new tls.TLSSocket()를 실행할 때 sec ctx 옵션을 지원합니다. (Sam Roberts) [#11005](https://github.com/nodejs/node/pull/11005)
* **url**: URL.prototype.toJSON이 추가됐습니다. (Michaël Zasso) [#11236](https://github.com/nodejs/node/pull/11236)
* **doc**: API 문서 항목에 변경 기록(changelog)을 입력할 수 있습니다. (Anna Henningsen) [#11489](https://github.com/nodejs/node/pull/11489)
* **crypto**: OPENSSL_CONF를 다시 지원합니다. (Sam Roberts) [#11006](https://github.com/nodejs/node/pull/11006)
* **src**: Trace 이벤트 추적을 지원합니다. (misterpoe) [#11106](https://github.com/nodejs/node/pull/11106)
