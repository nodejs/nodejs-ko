---
category: articles
title: Node v15.12.0(현재 버전)
author: Danielle Adams
ref: Node v15.12.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.12.0
...
* **crypto**:
  * crypto.sign과 crypto.verify에 선택적인 콜백을 추가했습니다. (Filip Skokan) [#37500](https://github.com/nodejs/node/pull/37500)
  * create\*Key에서 JWK 객체를 지원합니다. (Filip Skokan) [#37254](https://github.com/nodejs/node/pull/37254)
* **deps**:
  * openssl을 quictls/openssl로 변경했습니다. (James M Snell) [#37601](https://github.com/nodejs/node/pull/37601)
  * cjs-module-lexer@1.1.0로 업데이트했습니다. (Guy Bedford) [#37712](https://github.com/nodejs/node/pull/37712)
* **fs**:
  * fsPromises writeFile의 성능을 높였습니다. (Nitzan Uziely) [#37610](https://github.com/nodejs/node/pull/37610)
  * fsPromises readFile의 성능을 높였습니다. (Nitzan Uziely) [#37608](https://github.com/nodejs/node/pull/37608)
* **lib**:
  * AbortSignal.abort()를 구현했습니다. (James M Snell) [#37693](https://github.com/nodejs/node/pull/37693)
* **node-api**:
  * 8 버전을 정의했습니다. (Gabriel Schulhof) [#37652](https://github.com/nodejs/node/pull/37652)
* **worker**:
  * setEnvironmentData/getEnvironmentData를 추가했습니다. (James M Snell) [#37486](https://github.com/nodejs/node/pull/37486)
