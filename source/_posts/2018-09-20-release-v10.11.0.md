---
category: articles
title: Node v10.11.0(현재 버전)
author: Michaël Zasso
ref: Node v10.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v10.11.0
...
* **fs**
  * fsPromises.readdir `withFileTypes`를 수정했습니다. [#22832](https://github.com/nodejs/node/pull/22832)
* **http2**
  * `http2stream.endAfterHeaders` 속성을 추가했습니다. [#22843](https://github.com/nodejs/node/pull/22843)
* **util**
  * `util.types.isBoxedPrimitive(value)`를 추가했습니다. [#22620](https://github.com/nodejs/node/pull/22620)
* **새로운 협업자를 추가했습니다**:
  * [boneskull](https://github.com/boneskull) - Christopher Hiller
