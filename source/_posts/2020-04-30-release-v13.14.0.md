---
category: articles
title: Node v13.14.0(현재 버전)
author: Ruben Bridgewater
ref: Node v13.14.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.14.0
translator: mjayjang
---
<!-- 
### Notable Changes
...
* **async_hooks**:
  * `run`과 `exit` 메서드를 병합했습니다. (Andrey Pechkurov) [#31950](https://github.com/nodejs/node/pull/31950)
  * asyncLocalStorage의 동기화 메서드가 외부 컨텍스트를 종료시키지 않도록 수정했습니다. (Stephen Belanger) [#31950](https://github.com/nodejs/node/pull/31950)
* **vm**:
  * compileFunction에 `importModuleDynamically` 옵션을 추가했습니다. (Gus Caplan) [#32985](https://github.com/nodejs/node/pull/32985)
