---
category: articles
title: Node v7.7.4 (현재 버전)
author: Colin Ihrig
ref: Node v7.7.4 (Current)
refurl: https://nodejs.org/en/blog/release/v7.7.4
translator: originerd
---
...
이 릴리즈의 대부분을 준비해주신 @italoacasa 님께 감사드립니다.

* **deps**: 몇 가지 수정이 포함 된, 내부 node-inspect 버전을 1.10.6으로 업그레이드했습니다. (Jan Krems) [#11869](https://github.com/nodejs/node/pull/11869)
* **inspector**: 0.0.0.0로 연결할 때 적절한 WebSocket URL을 사용합니다. (Eugene Ostroukhov) [#11850](https://github.com/nodejs/node/pull/11850)
* **tls**: 부분을 읽은 후 핸들이 소멸할 때 세그멘테이션 오류를 수정하였습니다. (Ben Noordhuis) [#11898](https://github.com/nodejs/node/pull/11898)
