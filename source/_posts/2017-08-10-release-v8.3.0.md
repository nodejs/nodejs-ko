---
category: articles
title: Node v8.3.0(현재 버전)
author: Colin Ihrig
ref: Node v8.3.0 (Current)
refurl: https://nodejs.org/en/blog/release/v8.3.0
translator:
...
V8 엔진이 6.0 버전으로 업그레이드 되었는데, 성능적으로 상당한 변화가 있었습니다.
[#14574](https://github.com/nodejs/node/pull/14574)

성능변화에 대해 더 상세히 알고 싶다면 다음글에서 찾을 수 있습니다. https://medium.com/the-node-js-collection/get-ready-a-new-v8-is-coming-node-js-performance-is-changing-46a63d6da4de

#### 다른 주요 변경사항

* **DNS**
  * 독립적인 DNS resolver 인스턴스가 해당 요청을 취소하는 것과 함께 지금 지원됩니다.
    [#14518](https://github.com/nodejs/node/pull/14518)

* **N-API**
  * 오류 처리를 위한 여러 N-API기능이 오류 코드 할당 지원을 위해 변경되었습니다.
    [#13988](https://github.com/nodejs/node/pull/13988)
...
* **유틸리티들**
  * WHATWG 부호화 표준(`TextDecoder`와 `TextEncoder`)이 실험적 기능으로 구현되었습니다.
    [#13644](https://github.com/nodejs/node/pull/13644)
