---
category: articles
title: Node v12.11.0(현재 버전)
author: Ruben Bridgewater
ref: Node v12.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v12.11.0
...
* **crypto**:
  * `oaepLabel` 옵션을 추가했습니다 [#29489](https://github.com/nodejs/node/pull/29489)
* **deps**:
  * V8를 7.7.299.11로 업데이트하였습니다 [#28918](https://github.com/nodejs/node/pull/28918)
    * 더 효율적으로 메모리를 관리합니다
    * 스택 트레이스가 빨라졌습니다
    * `Intl.NumberFormat` API에 새로운 기능이 추가되었습니다
    * 더 자세한 정보는 <https://v8.dev/blog/v8-release-77>에서 확인하세요
* **events**:
  * `once`에 `EventTarget` 지원이 추가되었습니다 [#29498](https://github.com/nodejs/node/pull/29498)
* **fs**:
  * 메모리 파일 매핑 플래그 `UV_FS_O_FILEMAP`를 노출하였습니다 [#29260](https://github.com/nodejs/node/pull/29260)
* **inspector**:
  * `Session.connectToMainThread` API를 추가하였습니다 [#28870](https://github.com/nodejs/node/pull/28870)
* **process**:
  * `env.NODE_V8_COVERAGE`로 초기화 소스맵을 지원합니다 [#28960](https://github.com/nodejs/node/pull/28960)
* **stream**:
  * `_writev()`가 구현되어있을 경우 `_write()`를 생략 가능합니다 [#29639](https://github.com/nodejs/node/pull/29639)
* **tls**:
  * 시그니쳐 알고리즘을 오버라이드할 수 있는 옵션을 추가하였습니다 [#29598](https://github.com/nodejs/node/pull/29598)
* **util**:
  * `TextEncoder`에 `encodeInto`를 추가하였습니다 [#29524](https://github.com/nodejs/node/pull/29524)
* **worker**:
  * `worker_thread` 모듈은 이제 안정적입니다 [#29512](https://github.com/nodejs/node/pull/29512)
