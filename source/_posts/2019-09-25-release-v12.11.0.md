...
* **deps**:
  * V8을 7.7.299.11로 업데이트하였습니다 [#28918](https://github.com/nodejs/node/pull/28918)
    * 더 효율적으로 메모리를 관리합니다
    * 스택 트레이스가 빨라졌습니다
...
* **fs**:
  * 메모리 파일 매핑 플래그 `UV_FS_O_FILEMAP`을 노출하였습니다 [#29260](https://github.com/nodejs/node/pull/29260)
* **inspector**:
  * `Session.connectToMainThread` API를 추가하였습니다 [#28870](https://github.com/nodejs/node/pull/28870)
* **process**:
  * `env.NODE_V8_COVERAGE`로 초기 소스맵을 지원합니다 [#28960](https://github.com/nodejs/node/pull/28960)
* **stream**:
  * `_writev()`가 구현되어있을 경우 `_write()`를 생략 가능합니다 [#29639](https://github.com/nodejs/node/pull/29639)
* **tls**:
  * 시그니처 알고리즘을 오버라이드할 수 있는 옵션을 추가하였습니다 [#29598](https://github.com/nodejs/node/pull/29598)
* **util**:
