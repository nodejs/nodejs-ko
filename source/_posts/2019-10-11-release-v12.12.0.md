...
* **deprecations**:
  * 문서에서 `process._tickCallback()`를 폐기 예정으로 표시했습니다. [#29781](https://github.com/nodejs/node/pull/29781)
* **esm**:
  * JSON 모듈을 실험적으로 다시 사용합니다. [#29754](https://github.com/nodejs/node/pull/29754)
* **fs**:
...
* **tls**:
  * `pauseOnConnect` 옵션을 적용합니다. [#29635](https://github.com/nodejs/node/pull/29635)
  * OpenSSL 엔진에 개인 z키를 위한 옵션을 추가했습니다. [#28973](https://github.com/nodejs/node/pull/28973)
