...
author: Myles Borins
ref: Node v4.6.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v4.6.2
...
* **deps**: LTS의 npm 버전을 2.15.11로 업그레이드 했습니다. (Kat Marchán) [#8928](https://github.com/nodejs/node/pull/8928)
* **repl**: 탭 자동 완성 목록에 전역 프로퍼티가 나타납니다. (Lance Ball) [#7369](https://github.com/nodejs/node/pull/7369)
* **url**: `url.format()`은 `search` 에 포함된 모든 `#`문자를 인코딩할 것입니다. (Ilkka Myller) [#8072](https://github.com/nodejs/node/pull/8072)
