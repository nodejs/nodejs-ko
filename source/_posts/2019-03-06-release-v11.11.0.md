---
category: articles
title: Node v11.11.0(현재 버전)
author: Ruben Bridgewater
ref: Node v11.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.11.0
...
* **n-api**:
  * 날째 객체를 구현했습니다. (Jarrod Connolly) [#25917](https://github.com/nodejs/node/pull/25917)
* **util**:
  * `util.inspect()`를 위해 깊이 축소 모드를 추가했습니다. (Ruben Bridgewater) [#26269](https://github.com/nodejs/node/pull/26269)
* **worker**:
  * 네이티브 애드온과의 통합을 향상시켰습니다. (Anna Henningsen) [#26175](https://github.com/nodejs/node/pull/26175)
  * MessagePort.prototype.onmessage는 웹 환경과 더 비슷한 인자를 사용합니다. (Anna Henningsen) [#26082](https://github.com/nodejs/node/pull/26082)
