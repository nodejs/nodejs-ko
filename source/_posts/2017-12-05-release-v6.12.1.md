...
* **build**:
  - --shared 옵션과 함께 실행한 npm이 동작하지 않던 버그를 수정했습니다. (Ben Noordhuis) [#16438](https://github.com/nodejs/node/pull/16438)
* **build**:
  - Python 3를 사용한 빌드를 지원합니다. (Emily Marigold Klassen) [#16058](https://github.com/nodejs/node/pull/16058)
* **src**:
  - NODE_OPTIONS에 '\_' 또는 '-'을 사용하여 V8 옵션을 설정할 수 있습니다. (Sam Roberts) [#14093](https://github.com/nodejs/node/pull/14093)
