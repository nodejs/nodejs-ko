...
author: Myles Borins
ref: Node v6.9.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.9.2
translator:
...
* **buffer**: slice 파라미터가 일관되도록 강제합니다. (Sakthipriyan Vairamani (thefourtheye)) [#9101](https://github.com/nodejs/node/pull/9101)
* **deps**:
    - *npm*: npm을 3.10.9로 업그레이드했습니다. (Kat Marchán) [#9286](https://github.com/nodejs/node/pull/9286)
    - *V8*: 엣지케이스를 해결하는 다양한 수정이 있었습니다.
      - V8 업스트림에서 3c39bac를 체리픽해서 가져왔습니다. (Cristian Cavalli) [#9138](https://github.com/nodejs/node/pull/9138)
      - V8 업스트림에서 7166503을 체리픽해서 가져왔습니다. (Cristian Cavalli) [#9173](https://github.com/nodejs/node/pull/9173)
* **gtest**: 테스트 보고서가 이제 yaml처럼 tap 주석을 출력합니다. (Johan Bergström) [#9262](https://github.com/nodejs/node/pull/9262)
* **inspector**: 인스펙터에서 사용자가 localhost 대신 127.0.0.1을 사용하도록 합니다. (Eugene Ostroukhov) [#9451](https://github.com/nodejs/node/pull/9451)
