---
category: articles
title: Node v13.11.0(현재 버전)
author: Myles Borins
ref: Node v13.11.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.11.0
translator: taggon
---
...
* **async_hooks**: asyncLocalStorage에 ennterWith라는 동기 메서드를 추가했습니다. (Stephen Belanger) [#31945](https://github.com/nodejs/node/pull/31945)
* **cli**: NODE\_OPTIONS에서 --jitless라는 V8의 플래그를 사용할 수 있습니다. (Andrew Neitsch) [#32100](https://github.com/nodejs/node/pull/32100)
* **fs**: mkdir을 재귀적으로 실행하면 생성된 첫 번째 폴더를 반환합니다. (Benjamin Coe) [#31530](https://github.com/nodejs/node/pull/31530)
* **n-api**: 버전 6을 정의했습니다. (Gabriel Schulhof) [#32058](https://github.com/nodejs/node/pull/32058)
* **os**: 커널 버전을 반환하는 함수를 추가했습니다. (Juan José Arboleda) [#31732](https://github.com/nodejs/node/pull/31732)
* **wasi**: returnOnExit 옵션을 추가했습니다. (Colin Ihrig) [#32101](https://github.com/nodejs/node/pull/32101)
