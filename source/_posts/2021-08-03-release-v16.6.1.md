---
category: articles
title: Node v16.6.1(현재 버전)
author: Michaël Zasso
ref: Node v16.6.1 (Current)
refurl: https://nodejs.org/en/blog/release/v16.6.1
...
* npm을 7.20.3으로 업데이트했습니다.(npm team) [#39579](https://github.com/nodejs/node/pull/39579)
* 일부 네이티브 모듈에 영향을 줄 수 있는 V8.9.2의 ABI 호환성을 깨뜨린 변경사항을 되돌렸습니다.(Michaël Zasso) [#39624](https://github.com/nodejs/node/pull/39624)
* 최소한 Webpack과 Jest에 영향을 준다고 밝혀진 오류 처리의 버그를 수정했습니다.(Guy Bedford) [#39593](https://github.com/nodejs/node/pull/39593)
