...
* **addons**:
  * 한 개 혹은 두 개 인자의 `AtExit()` 를 폐지하였습니다. 인자 세 개를 사용하는 `AtExit()` 혹은 `AddEnvironmentCleanupHook()`을 사용하세요. (Anna Henningsen) [#30227](https://github.com/nodejs/node/pull/30227)
* **child_process,cluster**:
