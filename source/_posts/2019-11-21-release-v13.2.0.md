...
* **addons**:
  * 하나 혹은 두 개 인자의 `AtExit()` 를 폐지하였습니다. 세 개 인자의 `AtExit()` 혹은 `AddEnvironmentCleanupHook()`을 사용하세요. (Anna Henningsen) [#30227](https://github.com/nodejs/node/pull/30227)
* **child_process,cluster**:
  * `serialization` 옵션을 추가하여, 자식 프로세스 IPC가 V8 serialization API를 사용할 수 있게 되었습니다.(예를 들어, set, map과 같은 데이터 타입을 통과시키기 위한 목적) (Anna Henningsen) [#30162](https://github.com/nodejs/node/pull/30162)
* **deps**:
