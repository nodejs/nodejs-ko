---
category: articles
title: Node v10.7.0(현재 버전)
author: Michaël Zasso
ref: Node v10.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v10.7.0
...
* **console**:
  * `console.timeLog()` 메서드를 구현했습니다. [#21312](https://github.com/nodejs/node/pull/21312)
* **deps**:
  * libuv 1.22.0으로 업그레이드했습니다. [#21731](https://github.com/nodejs/node/pull/21731)
  * ICU 62.1(Unicode 11, CLDR 33.1)로 업그레이드했습니다. [#21728](https://github.com/nodejs/node/pull/21728)
* **http**:
  * `http.request`에 `timeout`과 `agent` 옵션을 둘 다 전달할 수 있게 되었습니다. [#21204](https://github.com/nodejs/node/pull/21204)
* **inspector**:
  * `require('inspector').console`에서 원래의 console API를 노출합니다. [#21659](https://github.com/nodejs/node/pull/21659)
* **napi**:
  * bigint 숫자를 다루는 실험적 함수를 지원합니다. [#21226](https://github.com/nodejs/node/pull/21226)
* **process**:
  * `process.hrtime.bigint()` 메서드를 구현했습니다. [#21256](https://github.com/nodejs/node/pull/21256)
  * 시작 시 프로세스의 제목을 설정할 수 있는 명령행 인자 `--title`을 추가했습니다.
    [#21477](https://github.com/nodejs/node/pull/21477)
* **trace_events**:
  * process\_name 메타데이터를 추가했습니다. [#21477](https://github.com/nodejs/node/pull/21477)
* **새로운 협업자를 추가했습니다.**
  * [codebytere](https://github.com/codebytere) - Shelley Vohr
