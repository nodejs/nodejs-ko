...
ref: Node v12.14.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v12.14.1
translator: MJayJang
---
...
* **crypto**: 비대칭 암호화에 필요한 key값을 수정하였습니다. (Tobias Nießen) [#30249](https://github.com/nodejs/node/pull/30249)
* **deps**:
  * llhttp를 2.0.1로 업데이트하였습니다. (Fedor Indutny) [#30553](https://github.com/nodejs/node/pull/30553)
  * nghttp2를 1.40.0로 업데이트하였습니다. (gengjiawen) [#30493](https://github.com/nodejs/node/pull/30493)
* **v8**: 직렬화/역직렬화(SerDes) API를 안정(stable) 상태로 만들었습니다. (Anna Henningsen) [#30234](https://github.com/nodejs/node/pull/30234)
