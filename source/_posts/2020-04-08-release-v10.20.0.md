...
ref: Node v10.20.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.20.0
...
이번 릴리스와 향후 10.x 릴리스에서 macOS 바이너리는 macOS 10.15(카탈리나)와 Xcode 11를
...
* **buffer**: {read|write}Big\[U\]Int64{BE|LE} 메서드를 추가했습니다. (garygsc) [#19691](https://github.com/nodejs/node/pull/19691)
* **build**: macOS 패키지 공증 지원 (Rod Vagg) [#31459](https://github.com/nodejs/node/pull/31459)
* **deps**:
  * npm을 6.14.3 버전으로 업데이트했습니다. (Myles Borins) [#32368](https://github.com/nodejs/node/pull/32368)
  * openssl 소스를 1.1.1e 버전으로 업그레이드했습니다. (Hassaan Pasha) [#32328](https://github.com/nodejs/node/pull/32328)
  * libuv를 1.34.2 버전으로 업그레이드했습니다. (cjihrig) [#31477](https://github.com/nodejs/node/pull/31477)
* **n-api**:
  * napi\_get\_all\_property\_names를 추가했습니다. (himself65) [#30006](https://github.com/nodejs/node/pull/30006)
  * 인스턴스 당 상태를 관리하는 API를 추가했습니다. (Gabriel Schulhof) [#28682](https://github.com/nodejs/node/pull/28682)
  * 릴리스 6을 선언합니다 [#32058](https://github.com/nodejs/node/pull/32058)
  * NAPI\_CALL\_INTO\_MODULE을 함수로 바꿨습니다. (Anna Henningsen) [#26128](https://github.com/nodejs/node/pull/26128)
* **tls**:
  * TLSSocket에서 keylog 이벤트를 노출합니다. (Alba Mendez) [#27654](https://github.com/nodejs/node/pull/27654)
  * CLI에서 TLS 최대/최소 프로토콜의 기본값을 지원합니다. (Sam Roberts) [#27946](https://github.com/nodejs/node/pull/27946)
* **url**: urlToOptions()에서 유사 WHATWG URL을 지원합니다. (cjihrig) [#26226](https://github.com/nodejs/node/pull/26226)
