---
category: articles
title: Node v8.5.0(현재 버전)
author: Myles Borins
ref: Node v8.5.0 (Current)
refurl: https://nodejs.org/en/blog/release/v8.5.0
translator:
...
* **fs**
  * 더 효율적으로 파일을 복사하는 fs.copyFile과 fs.copyFileSync를 추가했습니다.
    [#15034](https://github.com/nodejs/node/pull/15034)
* **inspector**
  * async 스택 트레이스를 활성화했습니다. [#13870](https://github.com/nodejs/node/pull/13870)
* **module**
