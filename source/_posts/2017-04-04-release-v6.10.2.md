...
author: Myles Borins
ref: Node v6.10.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.10.2
translator: taggon
---
...
* **deps**
  - zlib의 버전을 1.2.11로 업그레이드했습니다. (Sam Roberts) [#10980](https://github.com/nodejs/node/pull/10980)
  - 세그먼테이션 오류를 일으키는 전개 연산자 회귀 버그에 대한 V8 엔진의 수정 사항을 반영했습니다. (Michaël Zasso) [#12037](https://github.com/nodejs/node/pull/12037)
* **repl**
  - Windows에서 REPL 화면을 망치는 커밋을 되돌렸습니다. (Myles Borins) [#12123](https://github.com/nodejs/node/pull/12123)
