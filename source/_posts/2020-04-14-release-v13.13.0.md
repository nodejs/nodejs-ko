...
* 새로운 함수 `fs.readv`와 이 함수의 sync 버전, promise 버전을 추가하였습니다. 이 함수는 `ArrayBufferView` 요소로 구성된 배열을 받으며 읽은 데이터를 각 버퍼에 순서대로 작성합니다. (Sk Sajidul Kadir) [#32356](https://github.com/nodejs/node/pull/32356).
