...
* **C++ API**
  * `AddPromiseHook`이 폐지 예정(deprecated) 상태가 되었습니다. 이 API는 `async_hooks`가 `Promise`를 지원하여 생기는 사용사례(use case)를 채우기 위해 추가되었습니다 (Anna Henningsen) [#26529](https://github.com/nodejs/node/pull/26529).
...
* **meta**
  ...
  * [Yongsheng Zhang](https://github.com/ZYSzys)를 협업자로 추가했습니다 [#26730](https://github.com/nodejs/node/pull/26730).
