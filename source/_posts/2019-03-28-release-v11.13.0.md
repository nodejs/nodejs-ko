---
category: articles
title: Node v11.13.0(현재 버전)
author: Michaël Zasso
ref: Node v11.13.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.13.0
translator: Fleta
---
...
* **crypto**
  * 공개 키를 개인 키에서 파생시킬 수 있습니다 (Tobias Nießen) [#26278](https://github.com/nodejs/node/pull/26278).
* **events**
  * `EventEmitter`를 Promise로 사용하기 위한 `once` 함수를 추가했습니다 (Matteo Collina) [#26078](https://github.com/nodejs/node/pull/26078).
* **tty**
  * `WriteStream`에 `hasColors` 메서드를 추가했습니다 (Ruben Bridgewater) [#26247](https://github.com/nodejs/node/pull/26247).
  * NO\_COLOR와 FORCE\_COLOR 지원이 추가되었습니다 (Ruben Bridgewater) [#26485](https://github.com/nodejs/node/pull/26485).
* **v8**
  * Chrome DevTools와 같은 도구에서 사용되는 형식으로 snapshot 생성이 가능한 `v8.getHeapSnapshot`과 `v8.writeHeapSnapshot`이 추가되었습니다 (James M Snell) [#26501](https://github.com/nodejs/node/pull/26501).
* **worker**
  * `worker.moveMessagePortToContext`를 추가했습니다. 이것은 다른 vm.Contexts에서 MessagePorts를 사용 가능하게 하여 vm 모듈이 제공하고자 하는 격리를 돕습니다. (Anna Henningsen) [#26497](https://github.com/nodejs/node/pull/26497).
* **C++ API**
  * `AddPromiseHook`이 폐지 예정(deprecated) 상태가 되었습니다. 이 API는 `async_hooks`가 `Promise`를 지원하여 생기는 use case를 채우기 위해 추가되었습니다 (Anna Henningsen) [#26529](https://github.com/nodejs/node/pull/26529).
  * Node.js 실행 중에 종료시킬 수 있는 `Stop` API가 추가되었습니다 (Gireesh Punathil) [#21283](https://github.com/nodejs/node/pull/21283).
* **meta**
  * [Gireesh Punathil](https://github.com/gireeshpunathil)이 기술 운영위원회(Technical Steering Committees)의 회원이 되었습니다 [#26657](https://github.com/nodejs/node/pull/26657).
  * [Yongsheng Zhang](https://github.com/ZYSzys)를 공동 작업자(collaborator)에 추가했습니다 [#26730](https://github.com/nodejs/node/pull/26730).
