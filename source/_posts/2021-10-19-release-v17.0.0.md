...
* [[`4b030d0573`](https://github.com/nodejs/node/commit/4b030d0573)] - **doc**: http에서 abort와 관련된 부분이 문서에서만 먼저 폐기 예정으로 표시합니다. (dr-js) [#36670](https://github.com/nodejs/node/pull/36670)
...
* [[`64287e4d45`](https://github.com/nodejs/node/commit/64287e4d45)] - **(SEMVER-MAJOR)** **module**: 트레일링 슬래시 패턴을 런타임에서 폐기 예정으로 표시합니다. (Guy Bedford) [#40117](https://github.com/nodejs/node/pull/40117)
