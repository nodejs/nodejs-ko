---
category: articles
title: Node v17.0.0(현재 버전)
author: Bethany Nicolle Griggs
ref: Node v17.0.0 (Current)
refurl: https://nodejs.org/en/blog/release/v17.0.0
...
* [[`f182b9b29f`](https://github.com/nodejs/node/commit/f182b9b29f)] - **(SEMVER-MAJOR)** **dns**: `dns.lookup` 옵션의 타입을 강제하는 기능을 런타임에서 폐기 예정으로 표시합니다..  (Antoine du Hamel) [#39793](https://github.com/nodejs/node/pull/39793)
* [[`4b030d0573`](https://github.com/nodejs/node/commit/4b030d0573)] - **doc**: http에서 abort와 관련된 부분이 문서에서만 먼저 폐기 예정으로 표시합니다. [#36670](https://github.com/nodejs/node/pull/36670)
* [[`36e2ffe6dc`](https://github.com/nodejs/node/commit/36e2ffe6dc)] - **(SEMVER-MAJOR)** **module**: 하위 경로 매핑이 제거되었습니다. (Guy Bedford) [#40121](https://github.com/nodejs/node/pull/40121)
* [[`64287e4d45`](https://github.com/nodejs/node/commit/64287e4d45)] - **(SEMVER-MAJOR)** **module**: 트레일링 슬래시 패턴이 런타임에서 폐기 예정으로 표시합니다. (Guy Bedford) [#40117](https://github.com/nodejs/node/pull/40117)
...
OpenSSL 3.0의 모든 기능에 대한 자세한 내용은 [OpenSSL 3.0 릴리스 블로그](https://www.openssl.org/blog/blog/2021/09/07/OpenSSL3.Final)를 참고하세요.

<https://github.com/nodejs/node/pull/38512>, <https://github.com/nodejs/node/pull/40478>에서 기여되었습니다.
...
V8 JavaScript 엔진이 V8 9.5로 업데이트되었습니다. 이 릴리스는 `Intl.DisplayNames` API와 `Intl.DateTimeFormat` API의 확장된 `timeZoneName` 옵션에 대한 추가적인 지원 타입이 포함되어 있습니다.
...
`readline` 모듈은 Readable 스트림(`process.stdin` 등)에서 한 번에 한 줄씩 데이터를 읽어오는 인터페이스를 제공합니다.

다음의 간단한 예제는 `readline` 모듈의 기본적인 사용 방법을 보여줍니다.
...
Antoine du Hamel가 기여했습니다. - https://github.com/nodejs/node/pull/37947
...
* [[`1b2749ecbe`](https://github.com/nodejs/node/commit/1b2749ecbe)] - **(SEMVER-MAJOR)** **dns**: dns.lookup()에서 기본값을 verbatim=true로 변경했습니다. (treysis) [#39987](https://github.com/nodejs/node/pull/39987)
* [[`59d3d542d6`](https://github.com/nodejs/node/commit/59d3d542d6)] - **(SEMVER-MAJOR)** **errors**: 종료를 일으키는 치명적인 예외에서 Node.js 버전을 출력합니다. (Divlo) [#38332](https://github.com/nodejs/node/pull/38332)
* [[`a35b7e0427`](https://github.com/nodejs/node/commit/a35b7e0427)] - **deps**: npm의 버전을 8.1.0으로 업그레이드했습니다. (npm team) [#40463](https://github.com/nodejs/node/pull/40463)
* [[`6cd12be347`](https://github.com/nodejs/node/commit/6cd12be347)] - **(SEMVER-MINOR)** **fs**: FileHandle.prototype.readableWebStream()을 추가했습니다. (James M Snell) [#39331](https://github.com/nodejs/node/pull/39331)
* [[`d0a898681f`](https://github.com/nodejs/node/commit/d0a898681f)] - **(SEMVER-MAJOR)** **lib**: structuredClone() 전역 메서드를 추가했습니다. (Ethan Arrowood) [#39759](https://github.com/nodejs/node/pull/39759)
* [[`e4b1fb5e64`](https://github.com/nodejs/node/commit/e4b1fb5e64)] - **(SEMVER-MAJOR)** **lib**: `DOMException`을 전역으로 노출합니다. (Khaidi Chu) [#39176](https://github.com/nodejs/node/pull/39176)
* [[`0738a2b7bd`](https://github.com/nodejs/node/commit/0738a2b7bd)] - **(SEMVER-MAJOR)** **stream**: 오류가 발생한 스트림에서 finishied도 오류가 발생해야 합니다. (Robert Nagy) [#39235](https://github.com/nodejs/node/pull/39235)
