...
* **async\_hooks**:
  - async_hooks에 이벤트 추적을 추가했습니다. (Andreas Madsen) [#15538](https://github.com/nodejs/node/pull/15538)
...
* **module**:
  - `module.builtinModules`이 내장 모듈의 목록을 반환합니다. (Jon Moss) [#16386](https://github.com/nodejs/node/pull/16386)
* **n-api**:
...
* **src**:
  - Electron처럼 Node를 임베드하는 환경에서 `Node::CreatePlatform`를 사용해 NodePlatform의 인스턴스를 새로 만들 수 있습니다. (Cheng Zhao) [#16981](https://github.com/nodejs/node/pull/16981)
* **stream**:
