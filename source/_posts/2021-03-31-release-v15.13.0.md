---
category: articles
title: Node v15.13.0(현재 버전)
author: Ruy Adorno
ref: Node v15.13.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.13.0
translator: taggon
---
...
* **buffer**:
  * btoa와 atob를 구현했습니다. (James M Snell) [#37529](https://github.com/nodejs/node/pull/37529)
* **deps**:
  * npm의 버전을 7.7.6으로 업그레이드했습니다. (Ruy Adorno) [#37968](https://github.com/nodejs/node/pull/37968)
    * 이 업데이트는 [`npm run`](https://github.com/npm/cli/pull/2864)과 [`npm exec`](https://github.com/npm/cli/pull/2886)에 워크스페이스 지원을 추가합니다.
* **doc**:
  * 안정성 지표에 Legacy 상태를 추가했습니다. (James M Snell) [#37784](https://github.com/nodejs/node/pull/37784)
  * @linkgoron을 협력자로 추가했습니다. (Nitzan Uziely) [#37817](https://github.com/nodejs/node/pull/37817)
* **http**:
