---
category: articles
title: Node v9.9.0(현재 버전)
author: Myles Borins
ref: Node v9.9.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.9.0
...
* **assert**:
  - 이제부터 strict 모드에서 `assert`가 만드는 모든 오류 메시지는 오류 차이점(diff)을 보여줍니다. (Ruben Bridgewater) [#17615](https://github.com/nodejs/node/pull/17615)
  - 이제부터 throws에서 유효성 검사 객체를 사용할 수 있습니다. (Ruben Bridgewater) [#17584](https://github.com/nodejs/node/pull/17584)
* **crypto**:
  - IV가 필요 없는 경우 IV 대신 null을 전달할 수 있습니다. (Tobias Nießen) [#18644](https://github.com/nodejs/node/pull/18644)
* **fs**:
...
* **tty**:
  - 터미널이 색상을 지원하는지 판단하는 getColorDepth 함수를 추가했습니다. (Ruben Bridgewater) [#17615](https://github.com/nodejs/node/pull/17615)
* **util**:
  - util.inspect에 compact 옵션을 추가했습니다. (Ruben Bridgewater) [#17576](https://github.com/nodejs/node/pull/17576)
* **새로운 협업자를 추가했습니다.**
  - [watson](https://github.com/watson) Thomas Watson
