...
author: Myles Borins
ref: Node v8.12.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v8.12.0
...
* **async_hooks**:
  - PromiseWrap.parentId의 이름을 변경했습니다. (Ali Ijaz Sheikh) [#18633](https://github.com/nodejs/node/pull/18633)
  - 안전하지 않은 emit{Before,After}를 폐기 예정으로 바꾸었습니다. (Ali Ijaz Sheikh) [#18513](https://github.com/nodejs/node/pull/18513)
* **cluster**:
  - cluster.settings에 cwd를 추가했습니다. (cjihrig) [#18399](https://github.com/nodejs/node/pull/18399)
  - 워커에서 windowsHide 옵션을 지원합니다. (Todd Wong) [#17412](https://github.com/nodejs/node/pull/17412)
* **crypto**:
  - 필수 입력값이 아닌 경우 IV 인자를 null로 설정할 수 있습니다. (Tobias Nießen) [#18644](https://github.com/nodejs/node/pull/18644)
* **deps**:
  - npm을 6.4.1로 업그레이드했습니다. (Kat Marchán) [#22591](https://github.com/nodejs/node/pull/22591)
  - libuv를 1.19.2로 업그레이드했습니다. (cjihrig) [#18918](https://github.com/nodejs/node/pull/18918)
  - node-inspect를 1.11.5로 업그레이드했습니다. (Jan Krems) [#21055](https://github.com/nodejs/node/pull/21055)
* **fs,net**:
  - stringToFlags()에서 as와 as+ 플래그를 지원합니다. (Sarat Addepalli) [#18801](https://github.com/nodejs/node/pull/18801)
  - fs 스트림과 소켓에서 'ready' 이벤트를 일으킵니다. (Sameer Srivastava) [#19408](https://github.com/nodejs/node/pull/19408)
* **http, http2**:
  - http.createServer()에 옵션을 추가했습니다. (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)-
  - 103 Early Hints 상태 코드를 추가했습니다. (Yosuke Furukawa) [#16644](https://github.com/nodejs/node/pull/16644)
  - .createServer에 http 폴백 옵션을 추가했습니다. (Peter Marton) [#15752](https://github.com/nodejs/node/pull/15752)
* **n-api**:
  - n-api가 이제 실험상태가 아닙니다. (Michael Dawson) [#19262](https://github.com/nodejs/node/pull/19262)
* **perf_hooks**:
  - 타임라인에 너무 많은 요소가 있을 때 경고합니다. (James M Snell) [#18087](https://github.com/nodejs/node/pull/18087)
* **src**:
  - NodePlatform을 관리하는 공개 API를 추가했습니다. (Cheng Zhao) [#16981](https://github.com/nodejs/node/pull/16981)
  - NODE\_OPTIONS에 --perf-(basic-)?prof를 허용합니다. (Leko) [#17600](https://github.com/nodejs/node/pull/17600)
  - 노드 내부의 포스트모텀 메타데이터를 허용합니다. (Matheus Marchini) [#14901](https://github.com/nodejs/node/pull/14901)
* **tls**:
  - TLSSocket에서 Finished 메시지를 노출합니다. (Anton Salikhmetov) [#19102](https://github.com/nodejs/node/pull/19102)
* **trace_events**:
  - 파일 패턴 cli 옵션을 추가했습니다. (Andreas Madsen) [#18480](https://github.com/nodejs/node/pull/18480)
* **util**:
  - util.getSystemErrorName()을 구현했습니다. (Joyee Cheung) [#18186](https://github.com/nodejs/node/pull/18186)
