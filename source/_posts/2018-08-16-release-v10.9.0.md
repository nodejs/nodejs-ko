---
category: articles
title: Node v10.9.0(현재 버전)
author: Rod Vagg
ref: Node v10.9.0 (Current)
refurl: https://nodejs.org/en/blog/release/v10.9.0
...
* **deps**:
  ...
  * V8을 6.7에서 6.8로 업그레이드했습니다.(Michaël Zasso) [#21079](https://github.com/nodejs/node/pull/21079)
    - 메모리가 감소하고 성능이 향상되었습니다. 상세내용은 <https://v8project.blogspot.com/2018/06/v8-release-68.html>를 참고하세요.
* **http**: `http.get()`와 `http.request()`(그리고 `https`의 메서드도 포함)가 `URL`과 `options` 객체를 위해 이제 세개의 인자를 받습니다.(Sam Ruby) [#21616](https://github.com/nodejs/node/pull/21616)
* 새로운 협업자를 추가했습니다.
  * Sam Ruby(<https://github.com/rubys>)
  * George Adams(<https://github.com/gdams>)
