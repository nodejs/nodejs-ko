---
category: articles
title: Node v8.4.0(현재 버전)
author: Anna Henningsen
ref: Node v8.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v8.4.0
...
* **HTTP2**
  * `--expose-http2` 플래그를 사용해서 내장 `http2`의 실험단계의 지원을 받을 수 있습니다.
    [#14239](https://github.com/nodejs/node/pull/14239)
...
* **Util**
  * `util.format`이 객체 출력을 위한 식별자 `%o`와 `%O`를 지원합니다.
    [#14558](https://github.com/nodejs/node/pull/14558)
