---
category: articles
title: Node v17.2.0(현재 버전)
author: Michaël Zasso
ref: Node v17.2.0 (Current)
refurl: https://nodejs.org/en/blog/release/v17.2.0
...
* \[[`06916490af`](https://github.com/nodejs/node/commit/06916490af)] - **(SEMVER-MINOR)** **async\_hooks**: async\_wrap 프로바이더를 노출했습니다. (Rafael Gonzaga) [#40760](https://github.com/nodejs/node/pull/40760)
* \[[`371ee64c92`](https://github.com/nodejs/node/commit/371ee64c92)] - **(SEMVER-MINOR)** **deps**: V8을 9.6.180.14로 업데이트했습니다. (Michaël Zasso) [#40488](https://github.com/nodejs/node/pull/40488)
* \[[`675c210b04`](https://github.com/nodejs/node/commit/675c210b04)] - **(SEMVER-MINOR)** **lib**: AbortSignal에 reason 속성을 추가했습니다. (James M Snell) [#40807](https://github.com/nodejs/node/pull/40807)
* \[[`0de2850680`](https://github.com/nodejs/node/commit/0de2850680)] - **(SEMVER-MINOR)** **src**: crypto 모듈에 x509.fingerprint512를 추가했습니다. (3nprob) [#39809](https://github.com/nodejs/node/pull/39809)
* \[[`fa9b5c35d2`](https://github.com/nodejs/node/commit/fa9b5c35d2)] - **stream**: thenable 지원을 폐기 예정으로 표시합니다. (Antoine du Hamel) [#40860](https://github.com/nodejs/node/pull/40860)
* \[[`534409d4e7`](https://github.com/nodejs/node/commit/534409d4e7)] - **stream**: 레거시 Stream을 사용할 때 finished 회귀 문제를 수정했습니다. (Matteo Collina) [#40858](https://github.com/nodejs/node/pull/40858)
