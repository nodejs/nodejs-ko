...
author: Myles Borins
ref: Node v4.8.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v4.8.0
translator: taggon
---
...
* **child_process**: spwan()에 쉘 옵션을 추가했습니다. (cjihrig) [#4598](https://github.com/nodejs/node/pull/4598)
* **deps**:
  * **v8**: 힙 스페이스에 관한 통계를 볼 수 있습니다. (Ben Ripkens) [#4463](https://github.com/nodejs/node/pull/4463)
* **crypto**:
  * ALPN을 지원합니다. (Shigeki Ohtsu) [#2564](https://github.com/nodejs/node/pull/2564)
  * 잘 알려진 CA 목록에 별도 인증서를 추가할 수 있습니다. (Sam Roberts) [#9139](https://github.com/nodejs/node/pull/9139)
* **fs**: fs.mkdtemp() 함수를 추가했습니다. (Florian MARGAINE) [#5333](https://github.com/nodejs/node/pull/5333)
* **process**:
  * `externalMemory`를 `process`에 추가했습니다. (Fedor Indutny) [#9587](https://github.com/nodejs/node/pull/9587)
  * process.cpuUsage()를 추가했습니다. (Patrick Mueller) [#10796](https://github.com/nodejs/node/pull/10796)
