...
이 모듈은 Node.js v15.1.0에서 처음 도입되었으며 더 큰 범위에서 테스트할 수 있도록 v14.17.0에서도 지원합니다.
...
* `https.request`
* `http2Session.request`
* `setImmediate`와 `setTimeout`의 프로미스 버전
...
* **deps**:
  * V8: 애플 실리콘 지원을 위해 다양한 패치를 백포트했습니다. (BoHong Li) [#38051](https://github.com/nodejs/node/pull/38051)
...
* **http**:
  ...
  * diagnostics\_channel은 요청의 시작과 종료를 보고합니다. (Stephen Belanger) [#34895](https://github.com/nodejs/node/pull/34895)
* **util**:
