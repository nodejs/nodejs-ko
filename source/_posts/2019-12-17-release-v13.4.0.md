---
category: articles
title: Node v13.4.0(현재 버전)
author: Myles Borins
ref: Node v13.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.4.0
translator: mjayjang
---
...
* **deps**:
  * npm을 6.13.4로 업데이트했습니다. [#30904](https://github.com/nodejs/node/pull/30904)
  * uvwasi를 업데이트했습니다. (Anna Henningsen) [#30745](https://github.com/nodejs/node/pull/30745)
  * libuv를 1.34.0로 업그레이드했습니다. (Colin Ihrig) [#30783](https://github.com/nodejs/node/pull/30783)
* **doc**:
  * http finished의 폐지 예정을 문서화했습니다. (Robert Nagy) [#28679](https://github.com/nodejs/node/pull/28679)
* **events**:
  * captureRejection 옵션을 추가했습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **http**:
  * captureRejection을 지원합니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
  * llhttp는 안전하지 않은 HTTP 헤더 파싱을 수용합니다. (Sam Roberts) [#30567](https://github.com/nodejs/node/pull/30567)
* **http2**:
  * 'request'와 'stream' 이벤트에 대한 거부 검출(captureRejection)을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **net**:
  * 'connection' 이벤트에 대한 거부 검출(captureRejection)을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **repl**:
  * 입력값을 미리 검사하는 preview 기능을 지원합니다. (Ruben Bridgewater) [#30811](https://github.com/nodejs/node/pull/30811)
* **stream**:
  * captureRejection 옵션을 지원합니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **tls**:
  * 'secureConnection'이벤트에 대한 거부 검출(captureRejection)을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
  * 현재 사용 중인 사이퍼 스위트의 IETF명을 노출합니다. (Sam Roberts) [#30637](https://github.com/nodejs/node/pull/30637)
* **worker**:
  * argv 생성자 옵션을 추가했습니다. (legendecas) [#30559](https://github.com/nodejs/node/pull/30559)
