...
* **http2**:
  * 'request'와 'stream' 이벤트에 대한 capture rejection을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **net**:
  * 'connection' 이벤트에 대한 capture rejection을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* **repl**:
...
* **tls**:
  * 'secureConnection'이벤트에 대한 capture rejection을 구현하였습니다. (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
