---
category: articles
title: Node v16.5.0(현재 버전)
author: Michaël Zasso
ref: Node v16.5.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.5.0
translator: taggon
---
...
-->
#### 실험적인 Web Streams API

이제 Node.js에서 [Web Streams API](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API)의 
실험적인 구현체를 사용할 수 있습니다.

실험적인 API이기 때문에 전역 객체에는 노출되지 않으며
새로 추가된 `stream/web` 코어 모듈을 통해서만 접근할 수 있습니다.

```js
import { ReadableStream, WritableStream } from 'stream/web';
// 혹은 from 'node:stream/web'
```

해당 모듈을 임포트하면 프로세스마다 실험적인 기능에 관한 경고가 나타납니다.

Web Streams API 자체는 구현되었으며 현재는 다양한 기존 코어 API와 통합하는 작업을 진행하고 있습니다.

James M Snell님이 공헌했습니다. - [#39062](https://github.com/nodejs/node/pull/39062)
...
* [[`83f3b959f9`](https://github.com/nodejs/node/commit/83f3b959f9)] - **(SEMVER-MINOR)** **fs**: 임시 디렉토리 접두어에 빈 문자열을 사용할 수 있습니다. (Voltrex) [#39028](https://github.com/nodejs/node/pull/39028)
* [[`c04fd2bb97`](https://github.com/nodejs/node/commit/c04fd2bb97)] - **deps**: npm의 버전을 7.19.1으로 업그레이드했습니다. (npm team) [#39225](https://github.com/nodejs/node/pull/39225)
