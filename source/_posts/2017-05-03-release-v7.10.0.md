---
category: articles
title: Node v7.10.0(현재 버전)
author: Evan Lucas
ref: Node v7.10.0 (Current)
refurl: https://nodejs.org/en/blog/release/v7.10.0
translator: taggon
---
...
* **crypto**: `randomFill`과 `randomFillSync` 메소드가 추가되었습니다. (Evan Lucas) [#10209](https://github.com/nodejs/node/pull/10209)
* **meta**: 새로운 협력자를 추가했습니다.
  * lucamaraschi 님을 협력자로 추가했습니다. (Luca Maraschi) [#12538](https://github.com/nodejs/node/pull/12538)
  * DavidCai1993 님을 협력자로 추가했습니다. (David Cai) [#12435](https://github.com/nodejs/node/pull/12435)
  * jkrems 님을 협력자로 추가했습니다. (Jan Krems) [#12427](https://github.com/nodejs/node/pull/12427)
  * AnnaMag 님을 협력자로 추가했습니다. (AnnaMag) [#12414](https://github.com/nodejs/node/pull/12414)
* **process**: Promise를 거절할 때 Symbol을 반환하면 강제로 종료되던 문제를 수정했습니다. (Cameron Little) [#11640](https://github.com/nodejs/node/pull/11640)
* **url**: 조금 더 WHATWG URL 명세에 맞게 수정했습니다. (Timothy Gu) [#12507](https://github.com/nodejs/node/pull/12507)
* **v8**
  * 재귀 호출 메소드에서 발생하는 스택 오버플로우 문제를 수정했습니다. (Ben Noordhuis) [#12460](https://github.com/nodejs/node/pull/12460)
  * g++ 7을 사용할 때 발생하는 빌드 오류를 수정했습니다. (Ben Noordhuis) [#12392](https://github.com/nodejs/node/pull/12392)
