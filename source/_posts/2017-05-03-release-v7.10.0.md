...
* **url**: 조금 더 WHATWG URL 스펙에 맞게 수정했습니다. (Timothy Gu) [#12507](https://github.com/nodejs/node/pull/12507)
* **v8**
  * 재귀 호출 메소드에서 발생하는 스택 오버폴로우 문제를 수정했습니다. (Ben Noordhuis) [#12460](https://github.com/nodejs/node/pull/12460)
  * g++ 7을 사용할 때 발생하는 빌드 에러를 수정했습니다. (Ben Noordhuis) [#12392](https://github.com/nodejs/node/pull/12392)
