---
category: articles
title: Node v15.9.0(현재 버전)
author: Danielle Adams
ref: Node v15.9.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.9.0
...
* **crypto**:
  * keyObject.export() 'jwk' 형식 옵션이 추가되었습니다. (Filip Skokan) [#37081](https://github.com/nodejs/node/pull/37081)
* **deps**:
  * libuv를 1.41.0으로 업그레이드했습니다. (Colin Ihrig) [#37360](https://github.com/nodejs/node/pull/37360)
* **doc**:
  * dmabupt를 협업자로 추가했습니다. (Xu Meng) [#37377](https://github.com/nodejs/node/pull/37377)
  * fs 문서 구조를 개선했습니다.  (James M Snell) [#37170](https://github.com/nodejs/node/pull/37170)
* **fs**:
  * fsPromises.watch()를 추가했습니다. (James M Snell) [#37179](https://github.com/nodejs/node/pull/37179)
  * fs.close()에서 기본 콜백을 사용합니다. (James M Snell) [#37174](https://github.com/nodejs/node/pull/37174)
  * watch에서 AbortSignal을 지원합니다. (Benjamin Gruenbaum) [#37190](https://github.com/nodejs/node/pull/37190)
* **perf_hooks**:
  * createHistogram을 도입했습니다. (James M Snell) [#37155](https://github.com/nodejs/node/pull/37155)
* **stream**:
  * Readable.from 오류 처리를 개선했습니다. (Benjamin Gruenbaum) [#37158](https://github.com/nodejs/node/pull/37158)
* **timers**:
  * setInterval의 async 이터레이터(`for await`)를 도입했습니다. (linkgoron) [#37153](https://github.com/nodejs/node/pull/37153)
* **tls**:
  * X509Certificate 객체로 cert/peer cert를 가져올 수 있게 되었습니다. (James M Snell) [#37070](https://github.com/nodejs/node/pull/37070)
