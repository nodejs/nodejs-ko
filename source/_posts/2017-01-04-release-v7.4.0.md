---
category: articles
title: Node v7.4.0(현재 버전)
author: Evan Lucas
ref: Node v7.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v7.4.0
...
* **buffer**:
  - 버퍼 할당의 성능을 ~11% 향상시켰습니다. (Brian White) [#10443](https://github.com/nodejs/node/pull/10443)
  - Buffer.from()의 성능을 ~50% 향상 시켰습니다. (Brian White) [#10443](https://github.com/nodejs/node/pull/10443)
* **events**: `EventEmitter.once()`의 성능을 ~27% 향상시켰습니다. (Brian White) [#10445](https://github.com/nodejs/node/pull/10445)
* **fs**: 버퍼를 지원하는 fs 메서드에 Uint8Array를 넘길 수 있습니다. (Anna Henningsen) [#10382](https://github.com/nodejs/node/pull/10382)
* **http**: http 서버의 성능을 ~7% 향상 시켰습니다. (Brian White) [#6533](https://github.com/nodejs/node/pull/6533)
* **npm**: v4.0.5로 업그레이드 했습니다. (Kat Marchán) [#10330](https://github.com/nodejs/node/pull/10330)
