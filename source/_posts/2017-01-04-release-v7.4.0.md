...
* **buffer**:
  ...
  - Buffer.from()의 성능을 ~50% 향상시켰습니다. (Brian White) [#10443](https://github.com/nodejs/node/pull/10443)
...
* **http**: http 서버의 성능을 ~7% 향상시켰습니다. (Brian White) [#6533](https://github.com/nodejs/node/pull/6533)
