---
category: articles
title: Node v11.15.0(현재 버전)
author: Shelley Vohr
ref: Node v11.15.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.15.0
...
* **deps**: OpenSSL-1.1.1에 관한 s390 asm 규칙을 추가했습니다. (Shigeki Ohtsu) [#19794](https://github.com/nodejs/node/pull/19794)
* **src**: .code와 SSL에 관한 오류 속성을 추가했습니다. (Sam Roberts) [#25093](https://github.com/nodejs/node/pull/25093)
* **tls**:
  * --tls-min-v1.2 CLI 스위치를 추가했습니다. (Sam Roberts) [#26951](https://github.com/nodejs/node/pull/26951)
  * 공유된 openssl 1.1.0을 지원합니다. (Sam Roberts) [#26951](https://github.com/nodejs/node/pull/26951)
  * 기본으로 지원하는 TLS 최고 버전을 TLSv1.2로 되돌렸습니다. (Sam Roberts) [#26951](https://github.com/nodejs/node/pull/26951)
  * 유효하지 않은 프로토콜 오류 형식에 관한 변경사항을 되돌렸습니다. (Sam Roberts) [#26951](https://github.com/nodejs/node/pull/26951)
  * TLSv1.3을 지원합니다. (Sam Roberts) [#26209](https://github.com/nodejs/node/pull/26209)
  * ERR\_TLS\_INVALID\_PROTOCOL\_METHOD에 code 속성을 추가했습니다. (Sam Roberts) [#24729](https://github.com/nodejs/node/pull/24729)
