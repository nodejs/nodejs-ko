---
category: articles
title: Node v17.3.0(현재 버전)
author: Danielle Adams
ref: Node v17.3.0 (Current)
refurl: https://nodejs.org/en/blog/release/v17.3.0
...
OpenSSL-3.0.1에는 libssl에서 X509\_verify\_cert() 내부 오류를 잘못 처리하는 CVE-2021-4044에 대한 수정이 포함되어 있습니다.(중간 심각도) OpenSSL의 이 취약점은 Node.js에서 이용될 수도 있습니다. 자세한 내용은 <https://www.openssl.org/news/secadv/20211214.txt>에서 볼 수 있습니다.

Richard Lau가 기여했습니다. [#41177](https://github.com/nodejs/node/pull/41177).
...
* **lib**:
  * AbortSignal이 클론하거나 전송할 수 있게 되었습니다. (James M Snell) [#41050](https://github.com/nodejs/node/pull/41050)
* **deps**:
  * npm의 버전을 8.3.0으로 업그레이드했습니다. (npm team) [#41127](https://github.com/nodejs/node/pull/41127)
* **doc**:
  * @bnb를 협업자로 추가했습니다. (Tierney Cyren) [#41100](https://github.com/nodejs/node/pull/41100)
* **process**:
  * `getActiveResourcesInfo()`를 추가했습니다. (Darshan Sen) [#40813](https://github.com/nodejs/node/pull/40813)
* **timers**:
  * 실험적으로 scheduler api를 추가했습니다. (James M Snell) [#40909](https://github.com/nodejs/node/pull/40909)
