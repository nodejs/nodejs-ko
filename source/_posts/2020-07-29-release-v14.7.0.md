---
category: articles
title: Node v14.7.0(현재 버전)
author: Myles Borins
ref: Node v14.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.7.0
...
* **deps**:
  * npm을 6.14.7로 업그레이드했습니다. (claudiahdz) [#34468](https://github.com/nodejs/node/pull/34468)
* **dgram**:
  * **(SEMVER-MINOR)** 받은 udp6 데이터그램에 IPv6 범위의 아이디 접미사를 추가했습니다. (Pekka Nikander) [#14500](https://github.com/nodejs/node/pull/14500)
* **src**:
  * **(SEMVER-MINOR)** SetPromiseRejectCallback을 막을 수 있게 되었습니다. (Shelley Vohr) [#34387](https://github.com/nodejs/node/pull/34387)
  * **(SEMVER-MINOR)** 모든 진단을 출력할 디렉터리를 설정할 수 있습니다. (AshCripps) [#33584](https://github.com/nodejs/node/pull/33584)
* **worker**:
  * **(SEMVER-MINOR)** EventTarget을 상속받은 MessagePort를 만들었습니다. (Anna Henningsen) [#34057](https://github.com/nodejs/node/pull/34057)
* **zlib**:
  * zlib 스트림을 지연 초기화하도록 바꾸었습니다. (Andrey Pechkurov) [#34048](https://github.com/nodejs/node/pull/34048)
* **새 협업자 추가**:
  * rexagod를 협업자로 추가했습니다. (Pranshu Srivastava) [#34457](https://github.com/nodejs/node/pull/34457)
  * AshCripps를 협업자로 추가했습니다. (AshCripps) [#34494](https://github.com/nodejs/node/pull/34494)
  * HarshithaKP를 협업자로 추가했습니다. (Harshitha K P) [#34417](https://github.com/nodejs/node/pull/34417)
  * Richard Lau의 릴리스 키를 추가했습니다. (Richard Lau) [#34397](https://github.com/nodejs/node/pull/34397)
