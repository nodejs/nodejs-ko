...
* **(SEMVER-MAJOR)** **fs**: rmdir recursive 옵션이 런타임 폐기 예정 상태가 되었습니다. (Antoine du Hamel) [#37302](https://github.com/nodejs/node/pull/37302)
...
* **(SEMVER-MAJOR)** **lib**: process.binding('util')이 타입 체커만을 반환하도록 만들었습니다. (Anna Henningsen) [#37819](https://github.com/nodejs/node/pull/37819)
...
* **(SEMVER-MAJOR)** **build**: Makefile 내 기본 PYTHON은 python3로 지정됩니다. (Michaël Zasso) [#37764](https://github.com/nodejs/node/pull/37764)
* **build**: Makefile이 fat 바이너리를 지원하기 위해 업데이트됩니다. (Ash Cripps) [#37861](https://github.com/nodejs/node/pull/37861)
* **(SEMVER-MAJOR)** **build**: OS X에서 ASLR(PIE)을 활성화합니다. (woodfairy) [#35704](https://github.com/nodejs/node/pull/35704)
