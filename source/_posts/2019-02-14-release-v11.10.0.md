---
category: articles
title: Node v11.10.0(현재 버전)
author: Michaël Zasso
ref: Node v11.10.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.10.0
...
**deps**
  * libuv를 1.26.0으로 업데이트했습니다. [#26037](https://github.com/nodejs/node/pull/26037)
  * npm을 6.7.0으로 업데이트했습니다. [#25804](https://github.com/nodejs/node/pull/25804)
**http, http2**
  * `response.writeHead`는 이제 응답 객체를 반환합니다. [#25974](https://github.com/nodejs/node/pull/25974)
**perf_hooks**
  * 히스토그램 기반의 API를 구현했습니다. [#25378](https://github.com/nodejs/node/pull/25378)
**process**
  * `process.features.inspector`를 노출시켰습니다. [#25819](https://github.com/nodejs/node/pull/25819)
**repl**
  * 프로그램적 repl을 위해 `repl.setupHistory`를 추가했습니다. [#25895](https://github.com/nodejs/node/pull/25895)
**tls**
  * 클라이언트 'session' 이벤트를 추가했습니다. [#25831](https://github.com/nodejs/node/pull/25831)
