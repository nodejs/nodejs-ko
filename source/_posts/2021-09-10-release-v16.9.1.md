---
category: articles
title: Node v16.9.1(현재 버전)
author: Richard Lau
ref: Node v16.9.1 (Current)
refurl: https://nodejs.org/en/blog/release/v16.9.1
translator: taggon
---
...
이번 릴리스는 Node.js 16.9.0 버전에서 업데이트된 V8 9.3 버전에서 발생한 [회귀 문제](https://github.com/nodejs/node/issues/40030)를 수정합니다.
