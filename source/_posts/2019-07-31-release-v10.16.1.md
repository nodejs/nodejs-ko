...
ref: Node v10.16.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.16.1
...
* **deps**: openssl을 1.1.1c로 업그레이드했습니다. (Sam Roberts) [#28212](https://github.com/nodejs/node/pull/28212)
* **stream**: `resume()`에서 무조건 `\_read()`를 호출하지 않습니다. (Anna Henningsen) [#26965](https://github.com/nodejs/node/pull/26965)
* **worker**: MessagePort 디시리얼라이징을 실패한 후 nullptr의 레퍼런스를 제거하도록 수정했습니다. (Anna Henningsen) [#25076](https://github.com/nodejs/node/pull/25076)
