...
author: Richard Lau
ref: Node v10.23.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.23.2
translator: taggon
---
...
릴리스 키는 메인 브랜치와 동기화되었습니다.

* **deps**:
  * npm의 버전을 6.14.11로 업그레이드했습니다. (Darcy Clarke) [#36838](https://github.com/nodejs/node/pull/36838)
