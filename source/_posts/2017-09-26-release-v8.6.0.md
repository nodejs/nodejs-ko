---
category: articles
title: Node v8.6.0(현재 버전)
author: James M Snell
ref: Node v8.6.0 (Current)
refurl: https://nodejs.org/en/blog/release/v8.6.0
translator:
...
* **crypto**
  * 다수의 ECDH 커브를 지원합니다. [#15206](https://github.com/nodejs/node/pull/15206)
* **dgram**
  * `setMulticastInterface()` API를 추가했습니다. [#7855](https://github.com/nodejs/node/pull/7855)
  * 이제 커스텀 lookup 함수를 지원합니다. [#14560](https://github.com/nodejs/node/pull/14560)
* **n-api**
  * 이제 명령행 플래그 없이도 N-API를 사용할 수 있습니다. [#14902](https://github.com/nodejs/node/pull/14902)
* **tls**
  * `parseCertString()`을 문서에서만 폐기예정으로 표시했습니다. [#14245](https://github.com/nodejs/node/pull/14245)
* **새로운 컨트리뷰터**
  * 새로운 컨트리뷰터로 Sebastiaan Deckers(@sebdeckers)를 추가했습니다! [#15354](https://github.com/nodejs/node/pull/15354)
