---
category: articles
title: Node v8.8.1(현재 버전)
author: Colin Ihrig
ref: Node v8.8.1 (Current)
refurl: https://nodejs.org/en/blog/release/v8.8.1
...
### 주요 변경사항
  ...
  * **net**:
    - null 핸들러일 때 발생하던 타임아웃을 수정했습니다. 이 회귀는 Node 8.8.0에서 발생했습니다.
    [#16489](https://github.com/nodejs/node/pull/16489)
