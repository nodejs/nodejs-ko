...
* **fs**:
  * (프로미스 버전) `fs.writev`, `fs.writevSync`, `filehandle.writev` 메서드를 추가했습니다. 이 메서드로 파일 디스크립터에 `ArrayBufferView`의 배열을 작성할 수 있습니다. (Anas Aboureada) [#25925](https://github.com/nodejs/node/pull/25925), (cjihrig) [#29186](https://github.com/nodejs/node/pull/29186).
* **http**:
  * `OutgoingMessage.prototype`에 세 가지 파라미터 `writableObjectMode`, `writableLength`, `writableHighWaterMark`를 추가했습니다. [#29018](https://github.com/nodejs/node/pull/29018).
* **stream**:
