---
category: articles
title: Node v12.3.0(현재 버전)
author: Ruben Bridgewater
ref: Node v12.3.0 (Current)
refurl: https://nodejs.org/en/blog/release/v12.3.0
...
* **esm**:
  * WebAssembly 모듈을 지원하는 `--experimental-wasm-modules` 플래그를 추가했습니다. (Myles Borins & Guy Bedford) [#27659](https://github.com/nodejs/node/pull/27659)
* **process**:
  * 치명적인 예외의 경우 `util.inspect`로 오류를 로그로 남길 수 있습니다. (Ruben Bridgewater) [#27243](https://github.com/nodejs/node/pull/27243)
* **repl**:
  * `process.on('uncaughtException')`를 지원합니다. (Ruben Bridgewater) [#27151](https://github.com/nodejs/node/pull/27151)
* **stream**:
  * `Readable.from` async iterator 유틸리티를 구현했습니다. (Guy Bedford) [#27660](https://github.com/nodejs/node/pull/27660)
* **tls**:
  * 내장된 루트 인증서를 노출합니다. (Ben Noordhuis) [#26415](https://github.com/nodejs/node/pull/26415)
  * `net.Server` 옵션을 지원합니다. (Luigi Pinca) [#27665](https://github.com/nodejs/node/pull/27665)
  * TLSSocket에서 `keylog` 이벤트를 노출합니다. (Alba Mendez) [#27654](https://github.com/nodejs/node/pull/27654)
* **worker**:
  * `MessagePort`에서 메시지를 받을 수 있게 되었습니다. (Anna Henningsen) [#27294](https://github.com/nodejs/node/pull/27294)
