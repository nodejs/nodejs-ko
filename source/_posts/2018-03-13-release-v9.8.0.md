---
category: articles
title: Node v9.8.0(현재 버전)
author: Myles Borins
ref: Node v9.8.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.8.0
translator: uyu423
---
...
* **crypto**:
  - SHA256 지문 값(fingerprint)으로 cert.fingerprint256을 추가했습니다. (Hannes Magnusson) [#17690](https://github.com/nodejs/node/pull/17690)
* **http2**:
  - HTTP/2 구현에서 중단된 연결과 관련된 문제가 해결되었습니다. (Anna Henningsen) [#18987](https://github.com/nodejs/node/pull/18987) [#19002](https://github.com/nodejs/node/pull/19002)
* **loader**:
  - --inspect-brk 옵션이 이제 esmodules에서 제대로 동작합니다. (Gus Caplan) [#18949](https://github.com/nodejs/node/pull/18949)
* **src**:
  - process.dlopen()이 잘 알려진 심볼을 로드합니다. (Ben Noordhuis) [#18934](https://github.com/nodejs/node/pull/18934)
* **trace_events**:
  - 파일 패턴 CLI 옵션이 추가되었습니다. (Andreas Madsen) [#18480](https://github.com/nodejs/node/pull/18480)
* **새로운 협업자를 추가했습니다.**
  - [MoonBall](https://github.com/MoonBall) Chen Gang
