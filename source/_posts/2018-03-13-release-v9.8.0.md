...
* **crypto**:
  - SHA256 지문 값(fingerpoint)로 cert.fingerprint256 이 추가되었습니다. (Hannes Magnusson) [#17690](https://github.com/nodejs/node/pull/17690)
* **http2**:
  - HTTP/2 구현에서 연결 중단 문제가 해결되었습니다. (Anna Henningsen) [#18987](https://github.com/nodejs/node/pull/18987) [#19002](https://github.com/nodejs/node/pull/19002)
* **loader**:
  - --inspect-brk 옵션이 이제 esmodules 에서 제대로 동작합니다. [#18949](https://github.com/nodejs/node/pull/18949)
* **src**:
  - process.dlopen() 이 잘 알려진 심볼들을 로드합니다. (Ben Noordhuis) [#18934](https://github.com/nodejs/node/pull/18934)
* **trace_events**:
