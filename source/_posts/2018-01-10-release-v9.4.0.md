---
category: articles
title: Node v9.4.0(현재 버전)
author: Myles Borins
ref: Node v9.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.4.0
...
* **async\_hooks**:
  - AsyncHooks Sensitive API와 runInAsyncIdScope가 폐기 예정이 되었습니다. 둘 다 문서로 만들어지지 않았습니다. (Andreas Madsen) [#16972](https://github.com/nodejs/node/pull/16972)
* **deps**:
  - nghttp2를 1.29.0으로 업데이트했습니다.(James M Snell) [#17908](https://github.com/nodejs/node/pull/17908)
  - npm을 5.6.0으로 업그레이드했습니다.(Kat Marchán) [#17535](https://github.com/nodejs/node/pull/17535)
  - V8 업스트림에서 50f7455를 체리픽했습니다.(Michaël Zasso) [#16591](https://github.com/nodejs/node/pull/16591)
* **events**:
  - _events 내부에 접근할 수 없도록 차단했습니다.(Anatoli Papirovski) [#17440](https://github.com/nodejs/node/pull/17440)
* **http**:
  - `clientError` 이벤트의 err에 rawPacket를 추가했습니다.(XadillaX) [#17672](https://github.com/nodejs/node/pull/17672)
* **http2**:
  - maxSessionMemory를 구현했습니다.(James M Snell) [#17967](https://github.com/nodejs/node/pull/17967)
  - originSet의 초기 지원을 추가했습니다.(James M Snell) [#17935](https://github.com/nodejs/node/pull/17935)
  - altsvc를 지원합니다.(James M Snell) [#17917](https://github.com/nodejs/node/pull/17917)
  - perf_hooks를 통합했습니다.(James M Snell) [#17906](https://github.com/nodejs/node/pull/17906)
  - Http2Session과 Http2Stream 소멸 코드를 리팩토링하고 정리했습니다.(James M Snell) [#17406](https://github.com/nodejs/node/pull/17406)
* **net**:
  - Socket.prototype.listen을 제거했습니다.(Ruben Bridgewater) [#13735](https://github.com/nodejs/node/pull/13735)
* **repl**:
  - 탭 자동완성에서 범위 내의 변수를 보여줍니다.(Michaël Zasso) [#16591](https://github.com/nodejs/node/pull/16591)
* **stream**:
  - {writeable/readable}State.length를 제거했습니다.(Calvin Metcalf) [#12857](https://github.com/nodejs/node/pull/12857)
  - 스트림에 flow와 buffer 속성을 추가했습니다.(Calvin Metcalf) [#12855](https://github.com/nodejs/node/pull/12855)
* **util**:
  - NODE_DEBUG 변수에서 와일드카드를 사용할 수 있습니다.(Tyler) [#17609](https://github.com/nodejs/node/pull/17609)
* **zlib**:
  - ArrayBuffer를 지원합니다.(Jem Bezooyen) [#16042](https://github.com/nodejs/node/pull/16042)
* **새로운 협업자를 추가했습니다**
  - [starkwang](https://github.com/starkwang) Weijia Wang
* **새로운 TSC 회원을 추가했습니다**
  - [danbev](https://github.com/danbev) Daniel Bevenius
