---
category: articles
title: Node v11.1.0(현재 버전)
author: Michaël Zasso
ref: Node v11.1.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.1.0
...
* **deps**
  * ICU가 63.1로 업데이트되었습니다. [#23715](https://github.com/nodejs/node/pull/23715)
* **repl**
  * 최상위 레벨 for-await-of는 이제 REPL에서 지원됩니다. [#23841](https://github.com/nodejs/node/pull/23841)
* **timers**
  * 타이머가 무한 루프에 빠져들 수 있는 문제가 수정되었습니다. [#23870](https://github.com/nodejs/node/pull/23870)
