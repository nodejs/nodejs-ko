---
category: articles
title: Node v9.7.0(현재 버전)
author: Rod Vagg
ref: Node v9.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v9.7.0
...
* **libuv**:
  - libuv 1.19.2로 업데이트했습니다.(Colin Ihrig) [#18918](https://github.com/nodejs/node/pull/18918)

* **src**:
  - Node.js에 특화된 포스트 모템 메타데이터를 초기 지원합니다.(Matheus Marchini) [#14901](https://github.com/nodejs/node/pull/14901)

* **timers**:
  - `setImmediate()`의 반환 값이 이제 `ref()`, `unref()` 메서드를 가집니다.(Anatoli Papirovski) [#18139](https://github.com/nodejs/node/pull/18139)

* **util**:
  - 이제 플랫폼에 특화된 숫자 에러 코드의 이름을 문자열로 가져올 수 있습니다.(Joyee Cheung) [#18186](https://github.com/nodejs/node/pull/18186)
