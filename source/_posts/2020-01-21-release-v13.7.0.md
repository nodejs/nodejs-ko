---
category: articles
title: Node v13.7.0(현재 버전)
author: Shelley Vohr
ref: Node v13.7.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.7.0
translator: taggon
---
...
* **deps**
  * libuv 1.34.1로 업그레이드했습니다. (cjihrig) [#31332](https://github.com/nodejs/node/pull/31332)
  * npm을 6.13.6 버전으로 업그레이드했습니다. (Ruy Adorno) [#31304](https://github.com/nodejs/node/pull/31304)
* **module**
  * 소스맵과 상호 작용하는 API를 추가했습니다. (bcoe) [#31132](https://github.com/nodejs/node/pull/31132)
  * 로더(loader)에 getSource, getFormat, transform 훅이 추가됐습니다. (Geoffrey Booth) [#30986](https://github.com/nodejs/node/pull/30986)
  * 논리적인 조건부 export 순서를 구현했습니다. (Guy Bedford) [#31008](https://github.com/nodejs/node/pull/31008)
  * 조건부 export 플래그를 제거했습니다. (Guy Bedford) [#31001](https://github.com/nodejs/node/pull/31001)
* **process**
  * uncaughtException 이벤트를 모니터링 할 수 있게 됐습니다.  (Gerhard Stoebich) [#31257](https://github.com/nodejs/node/pull/31257)
* **새로운 협업자를 추가했습니다.**
  * [GeoffreyBooth](https://github.com/GeoffreyBooth) - Geoffrey Booth. [#31306](https://github.com/nodejs/node/pull/31306)
