...
* **net**: `Socket.prototype.connect`가 콜백 함수 없이도 동작합니다. (Juwan Yoo) [#11762](https://github.com/nodejs/node/pull/11762)
* **url**: `URL.prototype.origin`이 `file://` URL에 대해 불분명한 값인 `'null'`을 반환하도록 했습니다. (Brian White) [#11691](https://github.com/nodejs/node/pull/11691)
