---
category: articles
title: Node v4.1.2 (안정 버전)
author: Node
ref: Node v4.1.2 (Stable)
refurl: https://nodejs.org/en/blog/release/v4.1.2/
translator:
...
이번 릴리스에는 [CVE-2015-7384](https://github.com/nodejs/node/issues/3138), 서비스 거부(Denial of Service, DoS) 버그의 수정이 포함되어 있습니다. 버그에 대한 자세한 내용은 [nodejs-sec](https://groups.google.com/forum/#!topic/nodejs-sec/fSNEQiuof6I) 그룹에서 볼 수 있습니다. 보안 릴리스에 대한 알림을 받고 싶다면 [nodejs-sec](https://groups.google.com/forum/#!forum/nodejs-sec)을 구독하기 바랍니다.
...
* **libuv**: v1.7.4에서 v1.7.5로 업그레이드 했습니다. 자세한 내용은 [릴리스 노트](https://github.com/libuv/libuv/releases/tag/v1.7.5)를 참고하세요. (Saúl Ibarra Corretgé) [#3010](https://github.com/nodejs/node/pull/3010)
  ...
  - AIX 지원이 개선되었습니다.
* **v8**:
  - v4.5.103.33에서 v4.5.103.35로 업그레이드 했습니다. (Ali Ijaz Sheikh) [#3117](https://github.com/nodejs/node/pull/3117)
  - 프로미스 과정의 속도를 높이기 위해 v8의 업스트림에서 [f782159](https://codereview.chromium.org/1367123003)를 백포트했습니다. (Ben Noordhuis) [#3130](https://github.com/nodejs/node/pull/3130)
  - 포스트-모템 메타데이터에서 JSTypedArray 길이를 추가하도록 v8의 업스트림에서 [c281c15](https://codereview.chromium.org/1363683002)를 백포트했습니다. (Julien Gilli) [#3031](https://github.com/nodejs/node/pull/3031)
