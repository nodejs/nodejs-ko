...
ref: Node v10.18.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.18.1
translator: taggon
---
...
* **http2**: 일시정지 후 발생하는 세션 메모리 계산 문제를 수정했습니다. (Michael Lehenbauer) [#30684](https://github.com/nodejs/node/pull/30684)
* **n-api**: napi_get_last_error의 버그를 수정했습니다. (Octavian Soldea) [#28702](https://github.com/nodejs/node/pull/28702)
* **tools**: tzdata를 2019c로 업데이트했습니다. (Myles Borins) [#30479](https://github.com/nodejs/node/pull/30479)
