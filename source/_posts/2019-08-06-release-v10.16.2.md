...
ref: Node v10.16.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.16.2
...
OpenSSL을 1.1.1c로 업그레이드하면서 엔트로피가 낮은 머신에서 간헐적으로 행이 생기는 [회귀](https://github.com/nodejs/node/issues/28932)가 발생했습니다. 이 릴리스는 그 회귀를 수정합니다.
