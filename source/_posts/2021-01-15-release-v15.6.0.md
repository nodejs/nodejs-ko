---
category: articles
title: Node v15.6.0(현재 버전)
author: Danielle Adams
ref: Node v15.6.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.6.0
...
* **child_process**:
  * 'overlapped' stdio 플래그를 추가했습니다. (Thiago Padilha) [#29412](https://github.com/nodejs/node/pull/29412)
  * fork에서 AbortSignal을 지원합니다. (Benjamin Gruenbaum) [#36603](https://github.com/nodejs/node/pull/36603)
* **crypto**:
  * 기초적인 보안 힙(heap)을 지원합니다. (James M Snell) [#36779](https://github.com/nodejs/node/pull/36779)
  * keygen 오류 처리의 버그를 수정했습니다. (James M Snell) [#36779](https://github.com/nodejs/node/pull/36779)
  * X509Certificate API를 도입했습니다. (James M Snell) [#36804](https://github.com/nodejs/node/pull/36804)
  * randomuuid를 구현했습니다. (James M Snell) [#36729](https://github.com/nodejs/node/pull/36729)
* **doc**:
  * Danielle Adams의 릴리스 키를 갱신했습니다. (Danielle Adams) [#36793](https://github.com/nodejs/node/pull/36793)
  * dnlup을 협업자로 추가했습니다. (Daniele Belardi) [#36849](https://github.com/nodejs/node/pull/36849)
  * panva를 협업자로 추가했습니다. (Filip Skokan) [#36802](https://github.com/nodejs/node/pull/36802)
  * yashLadha를 협업자로 추가했습니다. (Yash Ladha) [#36666](https://github.com/nodejs/node/pull/36666)
* **http**:
  * 에이전트의 기본 스케줄링 전략을 lifo로 설정했습니다. (Matteo Collina) [#36685](https://github.com/nodejs/node/pull/36685)
* **net**:
  * server.listen에서 abortSignal을 지원합니다. (Nitzan Uziely) [#36623](https://github.com/nodejs/node/pull/36623)
* **process**:
  * 페이지를 순회하지 않고 rss에 직접 접근할 수 있습니다. (Adrien Maret) [#34291](https://github.com/nodejs/node/pull/34291)
* **v8**:
  * 네이티브 `serdes` 생성자를 수정했습니다. (ExE Boss) [#36549](https://github.com/nodejs/node/pull/36549)
