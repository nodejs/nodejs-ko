...
* **child_process**:
  * `maxBuffer` 옵션을 전달했을 때, 오류를 사용할 수 없게 되기보다는 `stdout`과 `stderr`의 출력이 잘립니다. [nodejs/node#24951](https://github.com/nodejs/node/pull/24951)
* **policy**:
...
* **worker**:
  * 워커 스레드 내에서 읽기 전용 함수로 `process.umask()`를 이제 사용할 수 있습니다. [nodejs/node#25526](https://github.com/nodejs/node/pull/25526)
