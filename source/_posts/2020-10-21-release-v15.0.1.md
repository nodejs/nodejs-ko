---
category: articles
title: Node v15.0.1(현재 버전)
author: Bethany Nicolle Griggs
ref: Node v15.0.1 (Current)
refurl: https://nodejs.org/en/blog/release/v15.0.1
translator: taggon
---
...
* **crypto**: randomFillSync의 회귀 문제를 수정했습니다. (James M Snell) [#35723](https://github.com/nodejs/node/pull/35723)
  * 이는 https://github.com/nodejs/node/issues/35722 이슈를 수정합니다.
* **deps**: npm을 7.0.3 버전으로 업데이트했습니다. (Ruy Adorno) [#35724](https://github.com/nodejs/node/pull/35724)
* **doc**: Danielle Adams를 위한 릴리스 키를 추가했습니다. (Danielle Adams) [#35545](https://github.com/nodejs/node/pull/35545)
