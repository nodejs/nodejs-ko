...
* **events**:
  * EventTarget에서 signal을 지원합니다. (Benjamin Gruenbaum) [#36258](https://github.com/nodejs/node/pull/36258)
...
* **stream**:
  ...
  * Read/WriteStream이 FileHandle을 지원합니다. (Momtchil Momtchev) [#35922](https://github.com/nodejs/node/pull/35922)
* **worker**:
