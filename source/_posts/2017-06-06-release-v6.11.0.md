...
author: Myles Borins
ref: Node v6.11.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.11.0
translator:
...
* **build**:
  - mips64el 빌드를 지원합니다. (nanxiongchao) [#10991](https://github.com/nodejs/node/pull/10991)
* **cluster**:
  - disconnect()가 이제 연결이 끊긴 워커의 참조를 반환합니다. (Sean Villars) [#10019](https://github.com/nodejs/node/pull/10019)
* **crypto**:
  * 런타임에서 인증서 스토어를 선택할 수 있는 기능이 추가되었습니다. (Adam Majer) [#8334](https://github.com/nodejs/node/pull/8334)
  * 내장된 CA 대신 시스템의 CA를 사용합니다. (Adam Majer) [#8334](https://github.com/nodejs/node/pull/8334)
  * `Decipher`의 `setAuthTag()`와 `setAAD` 메서드가 이제 `this`를 반환합니다. (Kirill Fomichev) [#9398](https://github.com/nodejs/node/pull/9398)
  * OPENSSL_CONF 지원을 다시 추가했습니다. (Sam Roberts) [#11006](https://github.com/nodejs/node/pull/11006)
  * LazyTransform이 Streams1와 호환성을 가집니다. (Matteo Collina) [#12380](https://github.com/nodejs/node/pull/12380)
* **deps**:
  * libuv를 1.11.0으로 업그레이드했습니다. (cjihrig) [#11094](https://github.com/nodejs/node/pull/11094)
  * libuv를 1.10.2로 업그레이드했습니다. (cjihrig) [#10717](https://github.com/nodejs/node/pull/10717)
  * libuv를 1.10.1로 업그레이드했습니다. (cjihrig) [#9647](https://github.com/nodejs/node/pull/9647)
  * libuv를 1.10.0으로 업그레이드했습니다. (cjihrig) [#9267](https://github.com/nodejs/node/pull/9267)
* **dns**:
  * `resolve4()`와 `resolve6()`를 위해 `{ttl: true}`를 구현했습니다. (Ben Noordhuis) [#9296](https://github.com/nodejs/node/pull/9296)
* **process**:
  * NODE_NO_WARNINGS 환경 변수를 추가했습니다. (cjihrig) [#10842](https://github.com/nodejs/node/pull/10842)
* **readline**:
  - 히스토리에서 중복을 막는 옵션을 추가했습니다. (Danny Nemer) [#2982](https://github.com/nodejs/node/pull/2982)
* **src**:
  * 옵션이 끝났다는 의미로 "-e" 뒤에 "--"를 지원합니다. (John Barboza) [#10651](https://github.com/nodejs/node/pull/10651)
* **tls**:
  * 새로운 tls.TLSSocket()이 sec ctx 옵션을 지원합니다. (Sam Roberts) [#11005](https://github.com/nodejs/node/pull/11005)
  * 명백한 key/passphrase 조합을 허용합니다. (Sam Roberts) [#10294](https://github.com/nodejs/node/pull/10294)
