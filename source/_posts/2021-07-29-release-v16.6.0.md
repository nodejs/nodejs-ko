---
category: articles
title: Node v16.6.0(현재 버전)
author: Bethany Nicolle Griggs
ref: Node v16.6.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.6.0
translator: taggon
---
...
V8 엔진이 9.2.230.21 버전으로 업데이트 되었습니다.

이 버전에는 [`Array.prototype.at`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/at) 메서드가 새롭게 도입됩니다. 해당 메서드는 [Typed Array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/at)와 [문자열](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/at)에도 추가됩니다.
...
Michaël Zasso님이 공헌했습니다. - [#39470](https://github.com/nodejs/node/pull/39470)
...
* **CVE-2021-22930**: 스트림 취소시 http2를 종료할 때 메모리 해제 후 참조 문제 (높음)
  * Node.js는 공격자가 메모리 손상을 일으켜 프로세스의 동작을 변경할 수 있는
    ...
    자세한 내용은 <https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-22930>에서 볼 수 있습니다.
* [[`f93d2ac587`](https://github.com/nodejs/node/commit/f93d2ac587)] - **inspector**: 안정 상태로 바뀌었습니다. (Gireesh Punathil) [#37748](https://github.com/nodejs/node/pull/37748)
* [[`89b4770d5c`](https://github.com/nodejs/node/commit/89b4770d5c)] - **punycode**: 곧 폐지 예정일 기능이 되었습니다. (Antoine du Hamel) [#38444](https://github.com/nodejs/node/pull/38444)
* [[`b67214fe31`](https://github.com/nodejs/node/commit/b67214fe31)] - **(SEMVER-MINOR)** **repl**:  `--experimental-repl-await` 플래그가 기본값이 되었습니다. (hemanth.hm) [#34733](https://github.com/nodejs/node/pull/34733)
