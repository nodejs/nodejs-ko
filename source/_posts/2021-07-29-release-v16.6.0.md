...
이 버전에는 [`Array.prototype.at`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/at) 메소드가 새롭게 도입됩니다. 해당 메소드는 [Typed Array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/at)와 [문자열](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/at)에도 추가됩니다.
