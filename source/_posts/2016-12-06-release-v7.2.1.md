---
category: articles
title: Node v7.2.1(현재 버전)
author: Jeremiah Senkpiel
ref: Node v7.2.1 (Current)
refurl: https://nodejs.org/en/blog/release/v7.2.1
translator:
...
* **buffer**:
  - `new` 없는 `Buffer()` 호출에 대한 런타임 폐기를 복구했습니다. (Anna Henningsen) [#9529](https://github.com/nodejs/node/pull/9529)
  - 싱글 바이트 문자를 `UCS2`로 인코딩하는 `buffer.transcode()` 오류를 수정했습니다. (Anna Henningsen) [#9838](https://github.com/nodejs/node/pull/9838)
* **promise**: `--trace-warnings`가 이제 Promise 경고에 대한 유용한 스택트레이스를 출력합니다. (Anna Henningsen) [#9525](https://github.com/nodejs/node/pull/9525)
* **repl**: generator 함수의 올바른 파싱을 막는 버그를 수정했습니다. (Teddy Katz) [#9852](https://github.com/nodejs/node/pull/9852)
* **V8**: `instanceof`의 상당한 성능저하를 수정했습니다. (Franziska Hinkelmann) [#9730](https://github.com/nodejs/node/pull/9730)
