...
author: Myles Borins
ref: Node v8.16.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v8.16.0
...
* **n-api**:
  - 비동기 함수용 API를 추가했습니다. (Gabriel Schulhof) [#17887](https://github.com/nodejs/node/pull/17887)
  - 스레드 세이프 함수를 안정 상태로 변경했습니다. (Gabriel Schulhof) [#25556](https://github.com/nodejs/node/pull/25556)
