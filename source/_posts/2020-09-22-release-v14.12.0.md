---
category: articles
title: Node v14.12.0(현재 버전)
author: Ruy Adorno
ref: Node v14.12.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.12.0
translator: taggon
---
...
* **deps**:
  * uvwasi를 0.0.11 버전으로 업데이트했습니다. (Colin Ihrig) [#35104](https://github.com/nodejs/node/pull/35104)
* **n-api**:
  * N-API v7 버전을 작성했습니다. (Gabriel Schulhof) [#35199](https://github.com/nodejs/node/pull/35199)
  * 프로퍼티 기본값을 더 추가했습니다. (Gerhard Stoebich) [#35214](https://github.com/nodejs/node/pull/35214)
