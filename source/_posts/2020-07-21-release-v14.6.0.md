---
category: articles
title: Node v14.6.0(현재 버전)
author: Myles Borins
ref: Node v14.6.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.6.0
...
* **deps**:
  * libuv를 1.38.1로 업그레이드했습니다. (Colin Ihrig) [#34187](https://github.com/nodejs/node/pull/34187)
  * npm을 6.14.6으로 업그레이드했습니다. (claudiahdz) [#34246](https://github.com/nodejs/node/pull/34246)
  * **(SEMVER-MINOR)** V8을 8.4.371.19로 업데이트했습니다. (Michaël Zasso) [#33579](https://github.com/nodejs/node/pull/33579)
* **module**:
  * **(SEMVER-MINOR)** module.parent를 문서에서만 폐기 예정으로 표시했습니다. (Antoine du HAMEL) [#32217](https://github.com/nodejs/node/pull/32217)
  * **(SEMVER-MINOR)** package.json의 "imports" 필드 지원 (Guy Bedford) [#34117](https://github.com/nodejs/node/pull/34117)
* **src**:
  * **(SEMVER-MINOR)** Node를 임베드해서 사용할 때 esm 로더를 비활성활 할 수 있게 했습니다. (Shelley Vohr) [#34060](https://github.com/nodejs/node/pull/34060)
* **tls**:
  * **(SEMVER-MINOR)** 'createSecureContext'에 옵션을 추가했습니다. (Mateusz Krawczuk) [#33974](https://github.com/nodejs/node/pull/33974)
* **vm**:
  * **(SEMVER-MINOR)** 평가 후 실행하는 마이크로 태스크 모드를 추가했습니다. (Anna Henningsen) [#34023](https://github.com/nodejs/node/pull/34023)
* **worker**:
  * **(SEMVER-MINOR)** 관리되지 않는 파일 디스크립터를 추적하는 옵션을 추가했습니다. (Anna Henningsen) [#34303](https://github.com/nodejs/node/pull/34303)
* **새 협업자 추가**:
  * danielleadams를 협업자로 추가했습니다. (Danielle Adams) [#34360](https://github.com/nodejs/node/pull/34360)
  * ruyadorno를 협업자로 추가했습니다. (Ruy Adorno) [#34297](https://github.com/nodejs/node/pull/34297)
  * sxa를 협업자로 추가했습니다. (Stewart X Addison) [#34338](https://github.com/nodejs/node/pull/34338)
