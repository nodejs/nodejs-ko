...
* **(SEMVER-MAJOR)** **http**: OutboundMessage.prototype.flush를 EOL로 바꾸었습니다. (James M Snell) [#31164](https://github.com/nodejs/node/pull/31164)
* **(SEMVER-MAJOR)** **lib**: GLOBAL과 root 별칭을 EOL로 바꾸었습니다. (James M Snell) [#31167](https://github.com/nodejs/node/pull/31167)
...
* **cli, report**: --report-on-fatalerror를 안정(stable)으로 바꾸었습니다. (Colin Ihrig) [#32496](https://github.com/nodejs/node/pull/32496)
