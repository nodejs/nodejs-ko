...
유니버설 자바스크립트로 가는 길의 기반을 닦아주는 ESM 모듈 작성의 미래 증거 모델이 될 것이라고 믿고 있습니다. 자세한 내용은 문서를 참고하세요.
...
* **(SEMVER-MAJOR)** **doc**: Linux armv7을 위한 크로스 컴파일러 머신을 업데이트했습니다. (Richard Lau) [#32812](https://github.com/nodejs/node/pull/32812)
* **(SEMVER-MAJOR)** **doc**: Centos/RHEL 릴리스가 devtoolset-8을 사용하도록 업데이트했습니다. (Richard Lau) [#32812](https://github.com/nodejs/node/pull/32812)
...
ARM에서 Node.js 바이너리와 네이티브 애드온 간에 ABI가 맞지 않을 것입니다. `std::shared_ptr`와 상호작용하는 네이티브 애드온만 깨질 것입니다. Node.js 14의 차후 버전에서 수정할 것으로 기대하고 있습니다. - [#30786](https://github.com/nodejs/node/issues/30786)
...
* **cli, report**: --report-on-fatalerror가 안정(stable)으로 바뀌었습니다. (Colin Ihrig) [#32496](https://github.com/nodejs/node/pull/32496)
