---
category: articles
title: Node v16.1.0(현재 버전)
author: Michaël Zasso
ref: Node v16.1.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.1.0
...
* [[`8a90f55a05`](https://github.com/nodejs/node/commit/8a90f55a05)] - **(SEMVER-MINOR)** **fs**: fsPromises 라이브러리의 fileHandle read 함수는 파라미터 없이 사용 가능합니다. (Nitzan Uziely) [#38287](https://github.com/nodejs/node/pull/38287)
