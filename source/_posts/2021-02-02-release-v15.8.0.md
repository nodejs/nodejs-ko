---
category: articles
title: Node v15.8.0(현재 버전)
author: Michaël Zasso
ref: Node v15.8.0 (Current)
refurl: https://nodejs.org/en/blog/release/v15.8.0
...
* [[`110063d694`](https://github.com/nodejs/node/commit/110063d694)] - **(SEMVER-MINOR)** **crypto**: generatePrime/checkPrime 메서드를 추가했습니다. (James M Snell) [#36997](https://github.com/nodejs/node/pull/36997)
* [[`53a0bdff47`](https://github.com/nodejs/node/commit/53a0bdff47)] - **(SEMVER-MINOR)** **crypto**: 실험적으로 (Ed/X)25519/(Ed/X)448을 지원합니다. (James M Snell) [#36879](https://github.com/nodejs/node/pull/36879)
* [[`03460432af`](https://github.com/nodejs/node/commit/03460432af)] - **deps**: upgrade npm to 7.5.0 (Ruy Adorno) [#37117](https://github.com/nodejs/node/pull/37117)
* [[`03460432af`](https://github.com/nodejs/node/commit/03460432af)] - **deps**: npm을 7.5.0으로 업그레이드했습니다. (Ruy Adorno) [#37117](https://github.com/nodejs/node/pull/37117)
  * 이번 업데이트는 [`npm diff` command](https://github.com/npm/cli/pull/1319)를 추가했습니다.
* [[`2c7ad38c75`](https://github.com/nodejs/node/commit/2c7ad38c75)] - **(SEMVER-MINOR)** **dgram**: createSocket에서 AbortSignal을 지원합니다. (Nitzan Uziely) [#37026](https://github.com/nodejs/node/pull/37026)
* [[`b7c3f99f7e`](https://github.com/nodejs/node/commit/b7c3f99f7e)] - **doc**: Zijian Liu를 협업자로 추가했습니다. (ZiJian Liu) [#37075](https://github.com/nodejs/node/pull/37075)
* [[`02f1d2fda4`](https://github.com/nodejs/node/commit/02f1d2fda4)] - **esm**: 모듈에서 레거시 main 검색은 폐기 예정이 되었습니다. (Guy Bedford) [#36918](https://github.com/nodejs/node/pull/36918)
* [[`75124298d5`](https://github.com/nodejs/node/commit/75124298d5)] - **(SEMVER-MINOR)** **readline**: 히스토리 이벤트를 추가하고 초기 히스토리를 설정하는 옵션을 추가했습니다. (Mattias Runge-Broberg) [#33662](https://github.com/nodejs/node/pull/33662)
* [[`4e757eab96`](https://github.com/nodejs/node/commit/4e757eab96)] - **(SEMVER-MINOR)** **readline**: question 메서드에서 AbortController를 지원합니다. (Mattias Runge-Broberg) [#33676](https://github.com/nodejs/node/pull/33676)
