---
category: articles
title: Node v14.5.0(현재 버전)
author: Shelley Vohr
ref: Node v14.5.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.5.0
translator: taggon
---
...
-->
#### V8 엔진을 8.3 버전으로 업데이트했습니다

이 버전에서는 성능 개선이 있으며, 이제 WebAssembly가 메모리를 4GB까지 요청할 수 있습니다.

더 자세한 정보는 [V8 공식 블로그의 글](https://v8.dev/blog/v8-release-83)을 참고하세요.

Matheus Marchini와 Michaël Zasso가 공헌했습니다. [#33376](https://github.com/nodejs/node/pull/33376)
...
-->
#### 실험적인 EventTarget의 초기 구현

이 버전에는 새로운 실험적인 API `EventTarget`이 포함되어 있습니다.
이 API를 사용하면, 이벤트를 수신할 수도 있고 이벤트 리스너를 가질 수도 있는 DOM 인터페이스 객체를 만들 수 있습니다.

웹 API EventTarget의 다른 버전입니다.
...
James Snell이 공헌했습니다. [#33556](https://github.com/nodejs/node/pull/33556)
