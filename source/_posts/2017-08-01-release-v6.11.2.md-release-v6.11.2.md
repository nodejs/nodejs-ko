...
* **http**:
  - NODE_DEBUG=http 일 때, 구문 오류 분석이 보고됩니다. (Sam Roberts) [#13206](https://github.com/nodejs/node/pull/13206)
  - 에이전트 구조는 `new` 없이 활성화될 수 있습니다. (cjihrig) [#12927](https://github.com/nodejs/node/pull/12927)
* **zlib**:
