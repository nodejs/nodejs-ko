...
author: Myles Borins
ref: Node v6.11.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.11.2
...
* **configure**:
  - valid_arch에 mips64el이 추가되었습니다. (Aditya Anand) [#13620](https://github.com/nodejs/node/pull/13620)
* **crypto**:
  - [NSS 3.30](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.30_release_notes) 기반의 루트 인증서가 업데이트되었습니다. (Ben Noordhuis)
    - [#13279](https://github.com/nodejs/node/pull/13279)
    - [#12402](https://github.com/nodejs/node/pull/12402)
* **deps**:
  - OpenSSL이 1.0.2.l 버전으로 업그레이드되었습니다. (Shigeki Ohtsu) [#12913](https://github.com/nodejs/node/pull/12913)
* **http**:
  - NODE_DEBUG=http일 때, 구문 오류 분석이 보고됩니다. (Sam Roberts) [#13206](https://github.com/nodejs/node/pull/13206)
  - Agent를 `new`없이 생성할 수 있게 되었습니다. (cjihrig) [#12927](https://github.com/nodejs/node/pull/12927)
* **zlib**:
  - zlib가 windowBits의 값을 거부하면, node가 충돌하는 대신 오류를 발생시킵니다. (Alexey Orlenko) [#13098](https://github.com/nodejs/node/pull/13098)
