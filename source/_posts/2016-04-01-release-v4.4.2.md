...
* **https**:
  - 특정 조건에서 keepalive가 활성화되면 ssl 소켓이 메모리 누수를 일으키고 있었습니다. 이제 더는 발생하지 않습니다. (Alexander Penev) [#5713](https://github.com/nodejs/node/pull/5713)
* **lib**:
...
* **repl**:
  - 이전에 제한 모드에서 repl의 사용은 stack trace의 column number 문제를 발생시켰습니다. 이제 더는 문제가 발생하지 않습니다. (Prince J Wesley) [#5416](https://github.com/nodejs/node/pull/5416)
