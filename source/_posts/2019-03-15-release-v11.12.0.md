---
category: articles
title: Node v11.12.0(현재 버전)
author: Ruben Bridgewater
ref: Node v11.12.0 (Current)
refurl: https://nodejs.org/en/blog/release/v11.12.0
translator: taggon
---
...
* **bootstrap**:
  * 실험적인 `--frozen-intrinsics` 플래그를 추가했습니다. (Guy Bedford) [#25685](https://github.com/nodejs/node/pull/25685)
* **build**:
  * 해시의 시드 작성을 위해 V8의 siphash를 사용 가능하도록 했습니다. (Rod Vagg) [#26367](https://github.com/nodejs/node/pull/26367)
* **deps**:
  * OpenSSL을 1.1.1b 버전으로 업그레이드 했습니다. (Sam Roberts) [#26327](https://github.com/nodejs/node/pull/26327)
* **process**:
  * 다시 `process[Symbol.toStringTag]`를 쓰기 가능하게 만들었습니다. (Ruben Bridgewater) [#26488](https://github.com/nodejs/node/pull/26488)
* **repl**:
  * writer를 커스터마이징 하기 위해 `util.inspect.replDefaults`를 추가했습니다. (Ruben Bridgewater) [#26375](https://github.com/nodejs/node/pull/26375)
* **report**:
  * `triggerReport()`의 이름을 `writeReport()`로 변경했습니다. (Colin Ihrig) [#26527](https://github.com/nodejs/node/pull/26527)
