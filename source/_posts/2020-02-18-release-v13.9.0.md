---
category: articles
title: Node v13.9.0(현재 버전)
author: Shelley Vohr
ref: Node v13.9.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.9.0
translator: taggon
---
...
* **async_hooks**
  * executionAsyncResource를 추가했습니다. (Matteo Collina) [#30959](https://github.com/nodejs/node/pull/30959)
* **crypto**
  * crypto.diffieHellman을 추가했습니다. (Tobias Nießen) [#31178](https://github.com/nodejs/node/pull/31178)
  * generateKeyPair에서 DH를 지원합니다. (Tobias Nießen) [#31178](https://github.com/nodejs/node/pull/31178)
  * DH 계열을 간결하게 만들었습니다. (Tobias Nießen) [#31178](https://github.com/nodejs/node/pull/31178)
  * 'dh' 키 타입을 추가했습니다. (Tobias Nießen) [#31178](https://github.com/nodejs/node/pull/31178)
* **test**
  * ARM 시스템에서는 키젠 테스트를 생략합니다. (Tobias Nießen) [#31178](https://github.com/nodejs/node/pull/31178)
* **perf_hooks**
  * GCPerformanceEntry에 여러 플래그 프로퍼티를 추가했습니다. (Kirill Fomichev) [#29547](https://github.com/nodejs/node/pull/29547)
* **process**
  * `memoryUsage()`가 ArrayBuffer 메모리 사용량도 보고합니다. (Anna Henningsen) [#31550](https://github.com/nodejs/node/pull/31550)
* **readline**
  * 탭 사이즈를 설정할 수 있게 했습니다. (Ruben Bridgewater) [#31318](https://github.com/nodejs/node/pull/31318)
* **report**
  * Worker를 지원합니다. (Anna Henningsen) [#31386](https://github.com/nodejs/node/pull/31386)
* **worker**
  * 부모 쓰레드의 힙 스냅샷을 만들 수 있습니다. (Anna Henningsen) [#31569](https://github.com/nodejs/node/pull/31569)
* **added new collaborators**
  * ronag가 협업자로 추가되었습니다. (Robert Nagy) [#31498](https://github.com/nodejs/node/pull/31498)
