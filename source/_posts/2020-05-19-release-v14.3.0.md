---
category: articles
title: Node v14.3.0 (현재 버전)
author: Shelley Vohr
ref: Node v14.3.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.3.0
...
프리뷰 중 `<enter>`를 누르면 이제 자동 완성된 부분이 포함된 전채 문자열을
...
* [[`7aa581f4ff`](https://github.com/nodejs/node/commit/7aa581f4ff)] - **(SEMVER-MINOR)** **repl**: repl.\_builtinLibs가 폐지 예정이 되었습니다.(Ruben Bridgewater) [#33294](https://github.com/nodejs/node/pull/33294)
* [[`db7bb941a3`](https://github.com/nodejs/node/commit/db7bb941a3)] - **(SEMVER-MINOR)** **repl**: repl.inputStream과 repl.outputStream가 폐지 예정이 되었습니다.(Ruben Bridgewater) [#33294](https://github.com/nodejs/node/pull/33294)
* [[`2dc5db8c07`](https://github.com/nodejs/node/commit/2dc5db8c07)] - **(SEMVER-MINOR)** **cli**: `--trace-atomics-wait` 플래그가 추가 되었습니다.(Anna Henningsen) [#33292](https://github.com/nodejs/node/pull/33292)
* [[`6257cf256e`](https://github.com/nodejs/node/commit/6257cf256e)] - **(SEMVER-MINOR)** **repl**: require 호출의 repl 자동완성을 향상하였습니다.(Ruben Bridgewater) [#33282](https://github.com/nodejs/node/pull/33282)
* [[`d33dcf1d5f`](https://github.com/nodejs/node/commit/d33dcf1d5f)] - **(SEMVER-MINOR)** **repl**: 프리뷰 중 레퍼런스 에러를 보여줍니다.(Ruben Bridgewater) [#33282](https://github.com/nodejs/node/pull/33282)
* [[`1dcf66cf87`](https://github.com/nodejs/node/commit/1dcf66cf87)] - **(SEMVER-MINOR)** **fs**: watcher 클래스에 .ref() 와 .unref() 메소드를 추가하였습니다.(rickyes) [#33134](https://github.com/nodejs/node/pull/33134)
* [[`f33e86649e`](https://github.com/nodejs/node/commit/f33e86649e)] - **(SEMVER-MINOR)** **http**: http.validate-header-name/value를 노출하였습니다.(osher) [#33119](https://github.com/nodejs/node/pull/33119)
* [[`b06165584e`](https://github.com/nodejs/node/commit/b06165584e)] - **(SEMVER-MINOR)** **async_hooks**: PromiseHook 핸들러를 JS로 옮겼습니다.(Stephen Belanger) [#32891](https://github.com/nodejs/node/pull/32891)
