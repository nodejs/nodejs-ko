---
category: articles
title: Node v16.4.0(현재 버전)
author: Danielle Adams
ref: Node v16.4.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.4.0
...
* **async_hooks**:
  * AsyncLocalStorage의 일부를 안정화시켰습니다. (Vladimir de Turckheim) [#37675](https://github.com/nodejs/node/pull/37675)
* **deps**:
  * npm의 버전을 7.18.1로 업그레이드했습니다. (npm-robot) [#39065](https://github.com/nodejs/node/pull/39065)
  * V8을 9.1.269.36으로 업데이트했습니다. (Michaël Zasso) [#38273](https://github.com/nodejs/node/pull/38273)
* **dns**:
  * `--dns-result-order`로 기본 dns의 verbatim의 값을 변경할 수 있습니다. (Ouyang Yadong) [#38099](https://github.com/nodejs/node/pull/38099)
