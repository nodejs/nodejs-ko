---
category: articles
title: Node v16.8.0(현재 버전)
author: Michaël Zasso
ref: Node v16.8.0 (Current)
refurl: https://nodejs.org/en/blog/release/v16.8.0
...
* [[`2e90b10f35`](https://github.com/nodejs/node/commit/2e90b10f35)] - **doc**: `dns.lookup` 옵션에 대한 타입 강제가 폐기 예정이 되었습니다.(Antoine du Hamel) [#38906](https://github.com/nodejs/node/pull/38906)
* [[`a6d50a18a0`](https://github.com/nodejs/node/commit/a6d50a18a0)] - **(SEMVER-MINOR)** **stream**: `stream.Duplex.from` 유틸리티를 추가했습니다.(Robert Nagy) [#39519](https://github.com/nodejs/node/pull/39519)
* [[`af7047a815`](https://github.com/nodejs/node/commit/af7047a815)] - **(SEMVER-MINOR)** **stream**: `isDisturbed` 헬퍼를 추가했습니다.(Robert Nagy) [#39628](https://github.com/nodejs/node/pull/39628)
* [[`66400374de`](https://github.com/nodejs/node/commit/66400374de)] - **(SEMVER-MINOR)** **util**: `toUSVString`을 노출했습니다.(Robert Nagy) [#39814](https://github.com/nodejs/node/pull/39814)
