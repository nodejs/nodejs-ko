...
새로운 핵심 모듈인 `wasi`는 [WebAssembly System Interface](https://wasi.dev/) 명세의 구현체를 제공하기 위해 등장하였습니다. WASI는 샌드박스가 적용된 WebAssembly 애플리케이션이 POSIX 같은 함수들의 집합체를 통해 사용 중인 운영체제에 접근하는 것을 허용합니다.
