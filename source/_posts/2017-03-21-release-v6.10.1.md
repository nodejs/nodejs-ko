...
author: Myles Borins
ref: Node v6.10.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.10.1
translator: taggon
---
...
* **performance**: 일부 API의 성능이 개선되었습니다.
  - `Buffer.compare()`는 대략 최대 35% 빨라졌습니다. (Brian White) [#10927](https://github.com/nodejs/node/pull/10927)
  - `buffer.toJSON()`은 대략 최대 2859% 빨라졌습니다. (Brian White) [#10895](https://github.com/nodejs/node/pull/10895)
  - `fs.*statSync()` 함수는 대략 최대 9.3% 빨라졌습니다. (Brian White) [#11522](https://github.com/nodejs/node/pull/11522)
  - `os.loadavg`는 최대 151% 빨라졌습니다. (Brian White) [#11516](https://github.com/nodejs/node/pull/11516)
  - `process.memoryUsage()`는 최대 34% 빨라졌습니다. (Brian White) [#11497](https://github.com/nodejs/node/pull/11497)
  - `querystring.unescape()`는 `Buffer`에 대해 평균적으로 15% 빨라졌습니다. (Brian White) [#10837](https://github.com/nodejs/node/pull/10837)
  - `querystring.stringify()`는 대략 최대 7.8% 빨라졌습니다. (Brian White) [#10852](https://github.com/nodejs/node/pull/10852)
  - `querystring.parse()`는 대략 최대 21% 빨라졌습니다. (Brian White) [#10874](https://github.com/nodejs/node/pull/10874)
* **IPC**: 유닉스 도메인 소켓(Unix Domain Socket)을 지원하는 플랫폼에서는 IPC 프로세서도 일괄 쓰기 작업이 가능해졌습니다. (Alexey Orlenko) [#10677](https://github.com/nodejs/node/pull/10677)
  - 작업량에 따라 성능이 최대 40%까지 향상되었습니다.
* **child_process**: `spawnSync`는 이제 시그널에 의해 자식 프로세스가 종료될 때 null `status`를 반환합니다. (cjihrig) [#11288](https://github.com/nodejs/node/pull/11288)
  - 이 덕분에 `spawn()`처럼 동작하던 부분이 수정됐습니다..
* **http**
  - `http.request()`를 사용할 때 제어 문자는 항상 거부됩니다. (Ben Noordhuis) [#8923](https://github.com/nodejs/node/pull/8923)
  - 헤더가 유효하지 않은 값을 포함하고 있을 때 보여주는 디버그 메시지가 추가되었습니다. (Evan Lucas) [#9195](https://github.com/nodejs/node/pull/9195)
* **node**: 힙 통계에서 4GB 이상의 값도 지원됩니다. (Ben Noordhuis) [#10186](https://github.com/nodejs/node/pull/10186)
* **timers**: 도메인 에러를 다룰 때 타이머 콜백의 순서가 그대로 유지됩니다. (John Barboza) [#10522](https://github.com/nodejs/node/pull/10522)
