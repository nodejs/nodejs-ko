---
category: articles
title: Node v13.12.0(현재 버전)
author: Myles Borins
ref: Node v13.12.0 (Current)
refurl: https://nodejs.org/en/blog/release/v13.12.0
translator: taggon
---
...
* **build**:
  * macOS 패키지 공증 지원 (Rod Vagg) [#31459](https://github.com/nodejs/node/pull/31459)
* **deps**:
  * npm을 6.14.4 버전으로 업그레이드했습니다. (Ruy Adorno) [#32495](https://github.com/nodejs/node/pull/32495)
  * uvwasi를 0.0.6 버전으로 업데이트했습니다. (Colin Ihrig) [#32309](https://github.com/nodejs/node/pull/32309)
  * libuv를 1.35.0 버전으로 업그레이드했습니다. (Colin Ihrig) [#32204](https://github.com/nodejs/node/pull/32204)
* **lib**:
  * CLI에 --disable-proto 옵션을 추가했습니다. (Gus Caplan) [#32279](https://github.com/nodejs/node/pull/32279)
* **node\_report**:
  * 진단 보고서 기능을 안정 상태로 변경했습니다. (Colin Ihrig) [#32242](https://github.com/nodejs/node/pull/32242)
* **worker**:
  * Worker 생성자에 URL 객체를 사용할 수 있습니다. (Antoine du HAMEL) [#31664](https://github.com/nodejs/node/pull/31664)
* **util**:
  * `util.promisify.custom`에 대응하는 글로벌 심볼을 사용합니다. (ExE Boss) [#31672](https://github.com/nodejs/node/pull/31672)
