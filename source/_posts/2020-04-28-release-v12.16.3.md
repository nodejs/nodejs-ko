...
ref: Node v12.16.3 (LTS)
refurl: https://nodejs.org/en/blog/release/v12.16.3
...
* **의존성**:
  * OpenSSL을 1.1.1g로 업데이트했습니다. (Hassaan Pasha) [#32971](https://github.com/nodejs/node/pull/32971).
  * c-ares를 1.16.0으로 업데이트했습니다. (Anna Henningsen) [#32246](https://github.com/nodejs/node/pull/32246).
  * 실험적인 uvwasi를 0.0.6으로 업데이트했습니다. (Colin Ihrig) [#32309](https://github.com/nodejs/node/pull/32309).
* **ESM(실험적)**:
  * 조건부 exports를 사용하거나 패키지 이름을 직접 처리하는 모듈에서 추가적인 경고를 더는 출력하지 않습니다. (Guy Bedford) [#31845](https://github.com/nodejs/node/pull/31845).
