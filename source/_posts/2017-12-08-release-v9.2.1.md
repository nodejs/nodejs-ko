---
category: articles
title: Node v9.2.1(현재 버전)
author: Evan Lucas
ref: Node v9.2.1 (Current)
refurl: https://nodejs.org/en/blog/release/v9.2.1
translator: taggon
---
...
* **buffer**:
  * 유효하지 않은 콘텐츠를 사용해 버퍼를 할당하면 아무 내용도 없는 버퍼가 됩니다. (Anna Henningsen) [#17428](https://github.com/nodejs/node/pull/17428)
* **deps**:
