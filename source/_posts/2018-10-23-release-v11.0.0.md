...
* 빌드
  * 더 이상 FreeBSD 10은 지원되지 않습니다. [#22617](https://github.com/nodejs/node/pull/22617)
* `child_process`
  * `windowsHide` 옵션의 기본값이 `true`로 변경되었습니다. [#21316](https://github.com/nodejs/node/pull/21316)
* `console`
  * 리셋되어야 하는 타이머가 존재하지 않는다면 `console.countReset()`은 경고를 출력합니다. [#21649](https://github.com/nodejs/node/pull/21649)
...
* 일반
  ...
  * `queueMicrotask()`의 실험적 구현이 추가되었습니다. [#22951](https://github.com/nodejs/node/pull/22951)
* 내부
  * 윈도우 성능 측정 지원은 삭제되었습니다. [#22485](https://github.com/nodejs/node/pull/22485)
  * `--expose-http2` 명령줄 옵션은 삭제되었습니다. [#20887](https://github.com/nodejs/node/pull/20887)
* 타이머
  * 인터벌 타이머는 이전 인터벌에서 에러를 던졌어도 다시 스케줄 됩니다. [#20002](https://github.com/nodejs/node/pull/20002)
  * `nextTick` 큐는 각 immediate 및 타이머 뒤에 실행됩니다. [#22842](https://github.com/nodejs/node/pull/22842)
* `util`
  ...
  * `NODE_DEBUG`가 `http`나 `http2`에 설정되어 있다면 런타임 경고가 출력됩니다. [#21914](https://github.com/nodejs/node/pull/21914)
