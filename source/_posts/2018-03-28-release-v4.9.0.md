---
category: articles
title: Node v4.9.0(유지보수 버전)
author: Myles Borins
ref: Node v4.9.0 (Maintenance)
refurl: https://nodejs.org/en/blog/release/v4.9.0
...
* **HTTP `Content-Length` 헤더 값에서 공백을 허용하지 않습니다.(CVE-2018-7159)**:
Node.js HTTP 파서는 `Content-Length` 헤더 값에 공백을 허용했습니다. 이제 숫자가 아닌 값과 마찬가지로 이러한 값은 연결을 거절하게 됩니다.
