...
* **http2**: 연결을 닫을 때 스케쥴링된 write가 있는지 검사합니다. (David Halls) [#36241](https://github.com/nodejs/node/pull/36241)
* **stream**: duplex에서 발생한 회귀 문제를 수정했습니다. (Momtchil Momtchev) [#35941](https://github.com/nodejs/node/pull/35941)
