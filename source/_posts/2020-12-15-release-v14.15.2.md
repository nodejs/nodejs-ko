...
ref: Node v14.15.2 (LTS)
refurl: https://nodejs.org/en/blog/release/v14.15.2
...
* **deps**:
  * npm을 6.14.9로 업그레이드했습니다. (Myles Borins) [#36450](https://github.com/nodejs/node/pull/36450)
  * acorn을 v8.0.4로 업데이트했습니다. (Michaël Zasso) [#35791](https://github.com/nodejs/node/pull/35791)
* **doc**: Danielle Adams의 릴리스 키를 추가했습니다. (Danielle Adams) [#35545](https://github.com/nodejs/node/pull/35545)
* **http2**: 연결을 닫을 때 스케줄링된 write가 있는지 검사합니다. (David Halls) [#36241](https://github.com/nodejs/node/pull/36241)
* **stream**: duplex의 end 이벤트에서 발생한 회귀 문제를 수정했습니다. (Momtchil Momtchev) [#35941](https://github.com/nodejs/node/pull/35941)
