---
category: articles
title: Node v4.8.6(유지보수 버전)
author: Myles Borins
ref: Node v4.8.6 (Maintenance)
refurl: https://nodejs.org/en/blog/release/v4.8.6
...
### 주요 변경사항
* **crypto**:
  - 루트 인증서를 갱신했습니다. (Ben Noordhuis) [#13279](https://github.com/nodejs/node/pull/13279)
  - 루트 인증서를 갱신했습니다. (Ben Noordhuis) [#12402](https://github.com/nodejs/node/pull/12402)
* **deps**:
  - 최신 버전의 INTL을 위한 지원 추가 (Bruno Pagani) [#13040](https://github.com/nodejs/node/pull/13040)
  - openssl 소스를 1.0.2m으로 업그레이드했습니다. (Shigeki Ohtsu) [#16691](https://github.com/nodejs/node/pull/16691)
  - openssl 소스를 1.0.2l로 업그레이드했습니다. (Daniel Bevenius) [#13233](https://github.com/nodejs/node/pull/13233)
