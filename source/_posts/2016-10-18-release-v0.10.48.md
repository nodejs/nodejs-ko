---
category: articles
title: Node v0.10.48(유지보수 버전)
author: Rod Vagg
ref: Node v0.10.48 (Maintenance)
refurl: https://nodejs.org/en/blog/release/v0.10.48
translator:
...
* c-ares: 단일바이트 버퍼가 덮어써 지는 문제 수정, CVE-2016-5180, 자세한 내용은
  <https://c-ares.haxx.se/adv_20160929.html>를 참고하세요. (Rod Vagg)
