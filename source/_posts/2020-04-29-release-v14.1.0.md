---
category: articles
title: Node v14.1.0(현재 버전)
author: Bethany Nicolle Griggs
ref: Node v14.1.0 (Current)
refurl: https://nodejs.org/en/blog/release/v14.1.0
...
* **deps**: openssl 소스를 1.1.1g로 업그레이드했습니다. (Hassaan Pasha) [#32971](https://github.com/nodejs/node/pull/32971)
* **doc**: juanarbol를 협업자로 추가했습니다. (Juan José Arboleda) [#32906](https://github.com/nodejs/node/pull/32906)
* **http**: abort를 폐기 예정으로 문서에 표시하고 문서를 개선했습니다. (Robert Nagy) [#32807](https://github.com/nodejs/node/pull/32807)
* **module**: do not warn when accessing 종료되지 않은 exports의 `__esModule`에 접근할 때 경고하지 않습니다. (Anna Henningsen) [#33048](https://github.com/nodejs/node/pull/33048)
* **n-api**: 스레드 세이프 함수에서 데드락을 탐지합니다. (Gabriel Schulhof) [#32860](https://github.com/nodejs/node/pull/32860)
* **src**: 대체재를 안내하고 임베더 API를 폐기 예정으로 표시합니다. (Anna Henningsen) [#32858](https://github.com/nodejs/node/pull/32858)
* **stream**:
  * close 이벤트 후 end 이벤트를 호출하지 않습니다. (Robert Nagy) [#33076](https://github.com/nodejs/node/pull/33076)
  * 레거시 스트림에서 close 이벤트를 기다리지 않습니다. (Robert Nagy) [#33058](https://github.com/nodejs/node/pull/33058)
  * 파이프라인은 종료되지 않은 스트림만 제거해야 합니다. (Robert Nagy) [#32968](https://github.com/nodejs/node/pull/32968)
* **vm**: compileFunction에 importModuleDynamically 옵션을 추가했습니다. (Gus Caplan) [#32985](https://github.com/nodejs/node/pull/32985)
