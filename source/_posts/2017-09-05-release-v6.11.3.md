...
author: Myles Borins
ref: Node v6.11.3 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.11.3
translator:
...
* **build**:
  - macOS에서 코드 서명을 수정했습니다.(Evan Lucas) [#14179](https://github.com/nodejs/node/pull/14179)
* **deps**:
  - V8 스냅샷 기능이 다시 활성화되었습니다!!(Yang Guo) [#14385](https://github.com/nodejs/node/pull/14385)
* **path**:
  - win32에서 볼륨의 상대 경로가 다시 동작합니다!(Timothy Gu) [#14440](https://github.com/nodejs/node/pull/14440)
* **tools**:
  - 이제 v6.x를 ICU 59로 빌드할 수 있습니다.(Steven R. Loomis) [#12078](https://github.com/nodejs/node/pull/12078)
