...
ref: Node v8.10.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v8.10.0
...
이번 릴리스에는 큰 변경사항이 많이 있습니다. V8, libuv, ICU를 업데이트하고 npm의 버그를 수정하고
OpenSSL 1.1.0을 사용한 빌드를 지원합니다.

### 주요 변경사항

* **deps**:
  * V8을 6.2.414.46로 업데이트했습니다. (Michaël Zasso) [#16413](https://github.com/nodejs/node/pull/16413)
  * V8 6.2에서 ABI의 호환이 깨진 변경사항을 되돌렸습니다. (Anna Henningsen) [#16413](https://github.com/nodejs/node/pull/16413)
  * libuv를 1.19.1로 업그레이드했습니다. (cjihrig) [#18260](https://github.com/nodejs/node/pull/18260)
  * npm 5.6.0을 다시 적용했습니다. (Myles Borins) [#18625](https://github.com/nodejs/node/pull/18625)
  * ICU를 60으로 업데이트했습니다. (Steven R. Loomis) [#16876](https://github.com/nodejs/node/pull/16876)
* **crypto**:
  * OpenSSL 1.1.0과 1.0.2를 지원합니다. (David Benjamin) [#16130](https://github.com/nodejs/node/pull/16130)
  * 인증(authentication) 태그 길이가 유효하지 않으면 경고를 보여줍니다. (Tobias Nießen) [#17566](https://github.com/nodejs/node/pull/17566)
* **async_hooks**:
  * defaultTriggerAsyncIdScope의 성능을 개선했습니다. (Anatoli Papirovski) [#18004](https://github.com/nodejs/node/pull/18004)
  * 형식화 배열(typed array) 스택을 빠른 경로로 사용합니다. (Anna Henningsen) [#17780](https://github.com/nodejs/node/pull/17780)
  * defaultTriggerAsyncId에 범위를 사용합니다. (Andreas Madsen) [#17273](https://github.com/nodejs/node/pull/17273)
  * 기본 컨텍스트에서 빠진 컨텍스트를 분리했습니다. (Andreas Madsen) [#17273](https://github.com/nodejs/node/pull/17273)
  * initTriggerId의 이름을 변경했습니다. (Andreas Madsen) [#17273](https://github.com/nodejs/node/pull/17273)
  * 문서로 만들어지지 않은 API를 폐기 예정으로 표시했습니다. (Andreas Madsen) [#16972](https://github.com/nodejs/node/pull/16972)
  * 가비지 컬렉트된 AsyncResource에 제거 이벤트를 추가했습니다. (Sebastian Mayr) [#16998](https://github.com/nodejs/node/pull/16998)
  * async_hooks에 추적 이벤트를 추가했습니다. (Andreas Madsen) [#15538](https://github.com/nodejs/node/pull/15538)
  * HTTPParser 트리거를 소켓에 설정합니다. (Andreas Madsen) [#18003](https://github.com/nodejs/node/pull/18003)
  * net 서버에 프로바이더 타입을 추가했습니다. (Andreas Madsen) [#17157](https://github.com/nodejs/node/pull/17157)
* **n-api**:
  * 애드온에서 이벤트 루프를 가져오는 헬퍼를 추가했습니다. (Anna Henningsen) [#17109](https://github.com/nodejs/node/pull/17109)
* **cli**:
  * NODE_OPTIONS에 --stack-trace-limit를 추가했습니다. (Anna Henningsen) [#16495](https://github.com/nodejs/node/pull/16495)
* **console**:
  * console.debug를 지원합니다. (Benjamin Zaslavsky) [#17033](https://github.com/nodejs/node/pull/17033)
* **module**:
  * builtinModules를 추가했습니다. (Jon Moss) [#16386](https://github.com/nodejs/node/pull/16386)
  * require.resolve()의 기본 경로를 변경했습니다. (cjihrig) [#17113](https://github.com/nodejs/node/pull/17113)
* **src**:
  * 애드온에서 이벤트 루프를 가져오는 헬퍼를 추가했습니다. (Anna Henningsen) [#17109](https://github.com/nodejs/node/pull/17109)
  * process.ppid를 추가했습니다. (cjihrig) [#16839](https://github.com/nodejs/node/pull/16839)
* **http**:
  * 일반적인 `Duplex` 스트림을 지원합니다. (Anna Henningsen) [#16267](https://github.com/nodejs/node/pull/16267)
  * `clientError` 이벤트의 오류에 rawPacket을 추가했습니다. (XadillaX) [#17672](https://github.com/nodejs/node/pull/17672)
  * IPv6 주소 지원을 개선했습니다. (Mattias Holmlund) [#14772](https://github.com/nodejs/node/pull/14772)
* **net**:
  * Windows에서 ADDRCONFIG DNS를 제거했습니다. (Bartosz Sosnowski) [#17662](https://github.com/nodejs/node/pull/17662)
* **process**:
  * win32에서 길이가 0인 환경 변수를 읽어올 때의 문제를 수정했습니다. (Anna Henningsen) [#18463](https://github.com/nodejs/node/pull/18463)
* **tls**:
  * 삭제할 때 스트림을 정리합니다. (Anna Henningsen) [#17478](https://github.com/nodejs/node/pull/17478)
* **process**:
  * 프로미스에서 처리하지 않은 거부(rejection)의 메시지를 개선했습니다. (Madara Uchiha) [#17158](https://github.com/nodejs/node/pull/17158)
* **stream**:
  * *State.highWaterMark의 사용을 제거했습니다. (Calvin Metcalf) [#12860](https://github.com/nodejs/node/pull/12860)
* **trace_events**:
  * 이벤트를 초기화하는 executionAsyncId를 추가했습니다. (Andreas Madsen) [#17196](https://github.com/nodejs/node/pull/17196)
