...
author: Myles Borins
ref: Node v6.13.1 (LTS)
refurl: https://nodejs.org/en/blog/release/v6.13.1
translator: taggon
---
...
* **http, tls**:
  - IPv6 주소에 대한 지원이 개선되었습니다. (Mattias Holmlund) [#14772](https://github.com/nodejs/node/pull/14772)
