...
ref: Node v10.22.0 (LTS)
refurl: https://nodejs.org/en/blog/release/v10.22.0
...
이번 릴리스는 Richard Lau([@richardlau](https://github.com/richardlau))가 준비하고 Beth Griggs([@BethGriggs](https://github.com/bethgriggs))가 올렸습니다.

### 주요 변경사항

* **deps**:
  * npm을 6.14.6으로 업그레이드했습니다. (claudiahdz) [#34246](https://github.com/nodejs/node/pull/34246)
  * openssl 소스를 1.1.1g로 업그레이드했습니다. (Hassaan Pasha) [#32982](https://github.com/nodejs/node/pull/32982)
* **n-api**:
  * `napi_detach_arraybuffer`를 추가했습니다. (legendecas) [#29768](https://github.com/nodejs/node/pull/29768)
