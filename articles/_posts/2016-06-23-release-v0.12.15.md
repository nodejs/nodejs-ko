...
* **libuv**: (CVE-2014-9748) undefined와 잠재적으로 안전하지 않은 행동을 초래할 수 있는 윈도우 XP와 윈도우 2003의 읽기/쓰기 잠금 구현 버그가 수정되었습니다. 자세한 내용은 <https://github.com/libuv/libuv/issues/515> 혹은 <https://nodejs.org/en/blog/vulnerability/june-2016-security-releases/>에서 찾을 수 있습니다.
