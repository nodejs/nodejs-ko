...
author: Myles Borins
ref: Node v4.4.7 (LTS)
refurl: https://nodejs.org/en/blog/release/v4.4.7/
...
- **debugger**:
  - (length 외에) 모든 배열의 속성들은 이제 repl(cjhrig)에서 출력될 수 있습니다. [#6448](https://github.com/nodejs/node/pull/6448)
- **npm**:
  - npm을 2.15.8 버전으로 업그레이드 했습니다. (Rebecca Turner) [#7412](https://github.com/nodejs/node/pull/7412)
- **stream**:
  - 4.4.5 버전에서 스트림 변경사항에서 점점 더 널리 퍼지는 버그를 수정했습니다. (Anna Henningsen) [#7160](https://github.com/nodejs/node/pull/7160)
- **V8**:
  - arm64에 충돌을 일으키는 crankshaft 내 버그를 수정했습니다. (Myles Borins) [#7442](https://github.com/nodejs/node/pull/7442)
  - JSmap과 JSSet과 같은 postmortem 정보에 빠진 클래스들을 추가했습니다. (evan.lucas) [#3792](https://github.com/nodejs/node/pull/3792)
