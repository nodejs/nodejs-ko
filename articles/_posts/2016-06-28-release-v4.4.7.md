...
- **debugger**:
  - (length 외에) 배열의 모든 속성은 이제 repl에서 출력될 수 있습니다. (cjhrig) [#6448](https://github.com/nodejs/node/pull/6448)
- **npm**:
  - npm을 2.15.8 버전으로 업그레이드 했습니다. (Rebecca Turner) [#7412](https://github.com/nodejs/node/pull/7412)
- **stream**:
  - 4.4.5 버전에서 스트림 변경사항이 있으면 더 자주 발생하는 버그를 수정했습니다. (Anna Henningsen) [#7160](https://github.com/nodejs/node/pull/7160)
- **V8**:
  - arm64에서 충돌을 일으키는 crankshaft 버그를 수정했습니다. (Myles Borins) [#7442](https://github.com/nodejs/node/pull/7442)
  - JSMap과 JSSet과 같은 postmortem 정보에 빠진 클래스를 추가했습니다. (evan.lucas) [#3792](https://github.com/nodejs/node/pull/3792)
