...
author: Myles Borins
ref: Node v4.2.5 (LTS)
refurl: https://nodejs.org/en/blog/release/v4.2.5/
...
* **assert**
  * Error를 확장하는 ES6 클래스를 허용합니다. (Rich Trott) [#4166](https://github.com/nodejs/node/pull/4166)
* **build**
  * "--partly-static" 빌드 옵션을 추가합니다. (Super Zheng) [#4152](https://github.com/nodejs/node/pull/4152)
* **deps**
  * V8 업스트림에서 066747e를 백포트합니다. (Ali Ijaz Sheikh) [#4655](https://github.com/nodejs/node/pull/4655)
  * V8 업스트림에서 200315c를 백포트합니다. (Vladimir Kurchatkin) [#4128](https://github.com/nodejs/node/pull/4128)
  * libuv의 버전을 1.8.0으로 업그레이드합니다. (Saúl Ibarra Corretgé)
* **docs**
  * 70개의 커밋을 통해 다양하게 업데이트되었습니다!
* **repl**
  * 문법 에러에 발생 위치 정보를 추가합니다. (cjihrig) [#4013](https://github.com/nodejs/node/pull/4013)
  * 디렉토리를 읽을 때 에러 메시지를 표시합니다. (Prince J Wesley) [#4170](https://github.com/nodejs/node/pull/4170)
* **tests**
  * 50개 이상의 커밋을 통해 다양하게 업데이트되었습니다.
* **tools**
  * cpplint에 탭 출력을 추가합니다. (Johan Bergström) [#3448](https://github.com/nodejs/node/pull/3448)
* **util**
  * 숨겨진 값의 검색을 허용합니다. (cjihrig) [#3988](https://github.com/nodejs/node/pull/3988)
...
* [[`ff539c5bb5`](https://github.com/nodejs/node/commit/ff539c5bb5)] - **cluster**: ignore queryServer msgs o* [[`87181cd74c`](https://github.com/nodejs/node/commit/87181cd74c)] - **assert**: accommodate ES6 classes that extend Error (Rich Trott) [#4166](https://github.com/nodejs/node/pull/4166)
