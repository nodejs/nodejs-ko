...
ref: Node v4.2.4 (LTS)
refurl: https://nodejs.org/en/blog/release/v4.2.4/
translator:
...
* 커밋 중 약 78% 정도가 문서 및 테스트 개선
* **domains**:
  - 잡히지 않은 예외의 처리 수정 (Julien Gilli) [#3884](https://github.com/nodejs/node/pull/3884)
* **deps**:
  - npm 2.14.12로 업그레이드 (Kat Marchán) [#4110](https://github.com/nodejs/node/pull/4110)
  - V8 upstream에서 819b40a 백포트 (Michaël Zasso) [#3938](https://github.com/nodejs/node/pull/3938)
  - node의 LICENSE 파일에서 npm 라이센스 부분 업데이트 (Kat Marchán) [#4110](https://github.com/nodejs/node/pull/4110)
