...
### 주요 변경사항
* **buffer**: 다양한 엣지 케이스에서 lastIndexOf와 indexOf를 수정했습니다. (Anna Henningsen) [#6511](https://github.com/nodejs/node/pull/6511)
* **child_process**: /system/bin/sh 명령어를 안드로이드에서 사용합니다. (Ben Noordhuis) [#6745](https://github.com/nodejs/node/pull/6745)
* **deps**:
  ...
  - Intl: ICU 57 bump (Steven R. Loomis) [#6088](https://github.com/nodejs/node/pull/6088)
* **repl**:
  - 탭을 복사하면 자동완성을 호출하지 않아야 합니다. (Eugene Obrezkov) [#5958](https://github.com/nodejs/node/pull/5958)
  - `Recoverable` 내보냈습니다. (Blake Embrey) [#3488](https://github.com/nodejs/node/pull/3488)
...
6.X 버전대가 릴리스 됨으로써 기존의 리틀 엔디언 모드에서 작동하는 64비트 바이너리 뿐만 아니라
