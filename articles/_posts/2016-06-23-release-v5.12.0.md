...
이것은 보안 릴리스입니다. 모든 Node.js 유저들은 수정된 취약점들에 대한 세부사항을 https://nodejs.org/en/blog/vulnerability/june-2016-security-releases 에서 보안 릴리스 요약을 참고해야 합니다.

* **buffer**
  * allocUnsafeSlow를 backport 했습니다. (Сковорода Никита Андреевич) [#7169](https://github.com/nodejs/node/pull/7169)
  * 음수 할당 길이를 무시합니다. (Anna Henningsen) [#7221](https://github.com/nodejs/node/pull/7221)
  * **deps**: v8 upstrea으로부터 3a9bfec를 backport 합니다. (Ben Noordhuis) [nodejs/node-private#40](https://github.com/nodejs/node-private/pull/40)
