...
* **etw**:
  - Correctly display descriptors for ETW events 9 and 23 on the windows platform. 
  윈도우 플렛폼에서 9~23 ETW events의 정확한 서술자를 표시합니다.
  (João Reis) [#5742](https://github.com/nodejs/node/pull/5742)
