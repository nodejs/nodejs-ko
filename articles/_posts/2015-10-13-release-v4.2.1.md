...
* 서버에서 파이프라인 HTTP 연결을 통해 클라이언트에게 보낼 데이터가 많이 쌓일 때, 사용중인 소켓이 파괴될 수 있습니다. [#3332](https://github.com/nodejs/node/issues/3332)와 [#3342](https://github.com/nodejs/node/pull/3342).
