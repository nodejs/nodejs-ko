...
# io.js와 Node.js 소식
이번 주에는 io.js [v2.3.1](https://github.com/nodejs/io.js/blob/master/CHANGELOG.md#2015-06-23-version-231-rvagg) 배포가 있고, 전체 변경사항은 [GitHub](https://github.com/nodejs/io.js/blob/master/CHANGELOG.md)에서 확인할 수 있습니다.
...
* **module**: `require()` 수행 중 syscalls의 횟수가 다시 급격하게 감소하게 되었고(참조 [#1801](https://github.com/nodejs/io.js/pull/1801) 이전 작업을 위한 v2.2.0부터 적용), 이로 인해 성능 향상이 있을 것입니다. (Pierre Inglebert) [#1920](https://github.com/nodejs/io.js/pull/1920).
* **npm**:
...
* Atlas 장치의 API가 이제 [Node.js를 지원합니다.](https://deviceatlas.com/blog/deviceatlas-api-node-js?utm_source=twitter&utm_medium=update&utm_campaign=node%20js%20support)
