...
* [Node Version 4.5.0 '아르곤' (LTS)](https://github.com/nodejs/node/pull/7688). 이전 버전과 달라진 전체 변경사항은 [GitHub](https://github.com/nodejs/node/blob/master/CHANGELOG.md)에서 확인할 수 있습니다.
...
* [Node Hero - Node.js 보안 강좌](https://blog.risingstack.com/node-hero-node-js-security-tutorial/): 이것은 Node.js 보안 강좌입니다. 흔하고 많은 공격으로부터 애플리케이션을 어떻게 방어하는지 배울 수 있습니다.
