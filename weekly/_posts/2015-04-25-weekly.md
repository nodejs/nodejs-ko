...
-->
io.js 1.8.1 릴리스, 새 TC 멤버를 위한 제안, 커뮤니티 업데이트, 행사 등등…
...
* DNS 질의 진행 중에 호출된 `dns.setServers()`가 assertion 실패로 프로세스를 크래시시킬 수 있음. [#894](https://github.com/iojs/io.js/issues/894)
* `url.resolve`가 다른 두 호스트 사이를 해석하는 중 URL의 인증 정보 부분을 교환할 수 있습니다. [#1435](https://github.com/iojs/io.js/issues/1435)
* readline: 분리된 이스케이프가 제대로 처리되지 않음 [#1403](https://github.com/iojs/io.js/issues/1403)
...
* mikeal, mscdex, shigeki를 새 TC 멤버로 추가하자는 제안 [iojs/io.js#1483](https://github.com/iojs/io.js/issues/1483#issuecomment-95128140)
