...
Node.js 사용자 설문 조사 결과 보고서는 마이크로서비스 아키텍처, 택시간 웹 애플리케이션, 사물인터넷(IoT)과 같은 동향의 선행 지수를 제공하는 이 방대한 커뮤니티에서 일어나는 새로운 동향에 대한 통찰력을 제공합니다. 이 보고서는 특히 Node.js를 사용하는 제품에서 사용되는 기술의 상세한 그림과 프론트 엔드, 백 엔드, IoT 개발자들의 언어 선호도(현재와 미래)를 보여줍니다.
...
* [NodeConf Adventure 2016](https://ti.to/nodeconf/adventure-2016), "NodeConf Adventure 첫 예매가 시작됩니다", 미국 캘리포니아 주 마린 카운티 워커 크릭(Walker Creek) 목장에서 2016년 6월 9일부터 12일까지 열립니다.
