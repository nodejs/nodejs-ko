...
* **v8**: 4.5.103.30에서 4.5.103.33로 중요치 않은 수정사항을 포함한 업그레이드가 있었습니다. (Ali Ijaz Sheikh) [#2870](https://github.com/nodejs/node/pull/2870).
...
* **libuv**: 1.7.4에서 1.7.3로 업그레이드했습니다. (Saúl Ibarra Corretgé) [#2817](https://github.com/nodejs/node/pull/2817)
...
* **npm**: 2.13.3에서 2.14.3로 보안 업데이트를 포함한 업그레이드를 했습니다. 더 자세한 사항은 https://github.com/npm/npm/releases/tag/v2.14.2을 참조하세요. (Kat Marchán) [#2696](https://github.com/nodejs/node/pull/2696).
...
* 에반젤리즘 WG 회원인 Tony Pujals가 [Node.js v4.0.0로의 진입](https://www.linkedin.com/pulse/node-v400-here-tony-pujals)이란 글을 게재했고, Node.js v4.0.0안의 ES6와 LTS, SemVer에 관해 이야기했습니다.
