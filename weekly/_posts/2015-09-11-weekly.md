...
* **fs**:
  ...
  - `fs.WriteStream`은 매우 빠른 대용량 쓰기를 허용하는 `_writev`를 구현합니다. (Ron Korving) [#2167](https://github.com/nodejs/node/pull/2167).
...
* **npm**: 2.14.3으로 버전 업그레이드, 자세한 사항은 <https://github.com/npm/npm/releases/tag/v2.14.3>을 참조하세요. (Kat Marchán) [#2822](https://github.com/nodejs/node/pull/2822).
...
* **timers**: 0.12로 이식하면서 타이머의 성능 향상이 있었고, 중요치 않은 수정사항도 포함 되어있습니다. (Jeremiah Senkpiel) [#2540](https://github.com/nodejs/node/pull/2540), (Julien Gilli) [nodejs/node-v0.x-archive#8751](https://github.com/nodejs/node-v0.x-archive/pull/8751) [nodejs/node-v0.x-archive#8905](https://github.com/nodejs/node-v0.x-archive/pull/8905)
