...
* **icu**: 중요한 성능 개선과 함께 버전 56으로 업데이트 되었습니다. (Steven R. Loomis) [#3281](https://github.com/nodejs/node/pull/3281)
* **node**:
  - 코드 실행없이 스크립트 문법를 검사하기 위한 `-c` (또는 `--check`) 명령어 인자가 새로 추가되었습니다. (Dave Eddy) [#2411](https://github.com/nodejs/node/pull/2411)
