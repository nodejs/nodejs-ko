...
* [StrongLoop에서 화살표 함수를 도입했습니다](https://strongloop.com/strongblog/an-introduction-to-javascript-es6-arrow-functions/). "화살표 함수는 더 간단한 문법과 부모 범위와 this를 공유하는 두 가지 주목적으로 제공됩니다."
