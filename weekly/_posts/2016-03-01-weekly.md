...
OpenSSL 릴리스 후 대략 약 24시간 내에 작성되는 영향 평가 및 상세 업데이트 내용을 포함한 최신 소식을 알고 싶다면 **nodejs-sec** 구글 그룹을 살펴보세요. **nodejs-sec** 구글 그룹은 <https://groups.google.com/forum/#!forum/nodejs-sec>에서 볼 수 있습니다.
